  ...
  var arisRegistration = /*#__PURE__*/function () {
      ...
      try {
        ...
        if (typeof this.formElement !== 'undefined') {
          ...
          _self.config = {
            ...
            rootDomain: 'https://' + window.location.hostname.replace(/^(www|welcome|dev|staging|in|stagingin|local)\./gi, ''),
            events: {}
          };
    ...
    _createClass(arisRegistration, [{
      ...
      value: function getQueryParams() {
        ...
        url = this.isValidURL(url) ? url : window.location.href;
        var qPs = {};
      ...
      value: function detectEnv() {
        if (window.location.href.match(/^https?:\/\/staging(in)?\.(.+?)/gi) !== null || window.location.href.match(/^https?:\/\/(.+?)\/staging\//gi) !== null) {
          return 'staging';
        }

        if (window.location.href.match(/^https?:\/\/(dev|local)\.(.+?)$/gi) !== null || window.location.href.match(/^https?:\/\/(.+?)\.capsule/gi) !== null || window.location.href.match(/^https?:\/\/(.+?)\/(dev|development)\//gi) !== null) {
          return 'development';
        }
      ...
      value: function parseReturnURL(returnURL) {
        ...
        if (typeof returnURL === 'string') {
          ...
          switch (environment) {
            ...
            case 'development':
            default:
              if (window.location.hostname.indexOf('local.') !== 0 && window.location.hostname.indexOf('.capsule') === -1) {
          ...
          switch (environment) {
            ...
            case 'staging':
              if (window.location.hostname.indexOf('stagingin.') > -1) {
                subdomain = 'stagingin.';
              } else {
                subdomain = 'staging.';
              }
          ...
          returnURL = 'https://' + subdomain + window.location.hostname.replace(/^(www|staging(in)?|dev|local|welcome|benvenuti|bienvenue|willkommen)?\.?/gi, '');
        }
