...
/***/ ((module) => {
  ...
  */
  ...
  /******/ 		}
  /******/ 		
  /******/ 		var chunkLoadingGlobal = self["webpackChunkreg_js"] = self["webpackChunkreg_js"] || [];
  ...
  /* harmony import */ var _css_default_css__WEBPACK_IMPORTED_MODULE_208__ = __webpack_require__(/*! ../css/default.css */ "./src/css/default.css");
  ...
  (function () {
    var arisRegistration = /*#__PURE__*/function () {
      function arisRegistration(userConfig) {
        _classCallCheck(this, arisRegistration);
  
        try {
          var _self = this;
  
          if (typeof userConfig.form === 'string') {
            var formElements = document.querySelectorAll(userConfig.form);
  
            if (Array.isArray(formElements)) {
              if (formElements.length === 1) {
                this.formElement = formElements[0];
              } else if (formElements.length === 0) {
                throw new Error('Selector "' + userConfig.form + '" does not match any form elements on the page');
              } else {
                throw new Error('Selector "' + userConfig.form + '" matches more than one element, please use a unique selector');
              }
            }
          }
  
          this.formElement = userConfig.form;
          this.rollbar = null;
  
          if (typeof this.formElement !== 'undefined') {
            var _userConfig$fpjs$toke, _userConfig, _userConfig$fpjs, _userConfig$fpjs$endp, _userConfig2, _userConfig2$fpjs;
  
            this.formElement.style.opacity = '0.00';
            this.formElement.style.transition = 'opacity 300ms ease';
            userConfig = userConfig || {};
            userConfig["default"] = userConfig["default"] || {};
  
            if (typeof userConfig.koreEndpoint === 'string') {
              userConfig.koreEndpoint = userConfig.koreEndpoint.replace(/(^https?:?\/?\/?)+?/gim, '').replace(/\/\//gim, '/').replace(/\/$/gim, '');
            }
  
            _self.config = {
              koreEndpoint: userConfig.koreEndpoint || null,
              koreVersion: 3,
              brand: userConfig.brand || null,
              locale: userConfig.locale || 'en-US',
              playMode: userConfig.playMode || 'Real',
              cookieDefaults: {
                expires: 1,
                path: '/',
              ...
              tracking: {
                url: "https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&",
                referrer: document.referrer.length > 0 ? document.referrer : null,
                user_agent: navigator.userAgent,
                tracking_id: null
              },
              fpjs: {
                token: (_userConfig$fpjs$toke = (_userConfig = userConfig) === null || _userConfig === void 0 ? void 0 : (_userConfig$fpjs = _userConfig.fpjs) === null || _userConfig$fpjs === void 0 ? void 0 : _userConfig$fpjs.token) !== null && _userConfig$fpjs$toke !== void 0 ? _userConfig$fpjs$toke : null,
                endpoint: (_userConfig$fpjs$endp = (_userConfig2 = userConfig) === null || _userConfig2 === void 0 ? void 0 : (_userConfig2$fpjs = _userConfig2.fpjs) === null || _userConfig2$fpjs === void 0 ? void 0 : _userConfig2$fpjs.endpoint) !== null && _userConfig$fpjs$endp !== void 0 ? _userConfig$fpjs$endp : null,
                deviceID: null
              },
              trackingType: userConfig.trackingType || null,
              captchaStatus: null,
              recaptchaToken: null,
              recaptchaId: null,
              brandPublicCredentials: null,
              userData: null,
              form: {},
              errorBox: null,
              ...
              countries: userConfig.countries || ["AF", "AX", "AL", "DZ", "AS", "AD", "AO", "AI", "AQ", "AG", "AR", "AM", "AW", "AU", "AT", "AZ", "BS", "BH", "BD", "BB", "BY", "BE", "BZ", "BJ", "BM", "BT", "BO", "BQ", "BA", "BW", "BV", "BR", "IO", "BN", "BG", "BF", "BI", "KH", "CM", "CA", "CV", "KY", "CF", "TD", "CL", "CN", "CX", "CC", "CO", "KM", "CG", "CD", "CK", "CR", "CI", "CW", "HR", "CU", "CY", "CZ", "DK", "DJ", "DM", "DO", "EC", "EG", "SV", "GQ", "ER", "EE", "ET", "FK", "FO", "FJ", "FI", "FR", "GF", "PF", "TF", "GA", "GM", "GE", "DE", "GH", "GI", "GR", "GL", "GD", "GP", "GU", "GT", "GG", "GN", "GW", "GY", "HT", "HM", "VA", "HN", "HK", "HU", "IS", "IN", "ID", "IR", "IQ", "IE", "IM", "IL", "IT", "JM", "JP", "JE", "JO", "KZ", "KE", "KI", "KP", "KR", "KW", "KG", "LA", "LV", "LB", "LS", "LR", "LY", "LI", "LT", "LU", "MO", "MK", "MG", "MW", "MY", "MV", "ML", "MT", "MH", "MQ", "MR", "MU", "YT", "MX", "FM", "MD", "MC", "MN", "ME", "MS", "MA", "MZ", "MM", "NA", "NR", "NP", "NL", "NC", "NZ", "NI", "NE", "NG", "NU", "NF", "MP", "NO", "OM", "PK", "PW", "PS", "PA", "PG", "PY", "PE", "PH", "PN", "PL", "PT", "PR", "QA", "RE", "RO", "RU", "RW", "BL", "SH", "KN", "LC", "MF", "PM", "VC", "WS", "SM", "ST", "SA", "SN", "RS", "SC", "SL", "SG", "SX", "SK", "SI", "SB", "SO", "ZA", "GS", "ES", "LK", "SD", "SR", "SJ", "SZ", "SE", "CH", "SY", "TW", "TJ", "TZ", "TH", "TL", "TG", "TK", "TO", "TT", "TN", "TR", "TM", "TC", "TV", "UG", "UA", "AE", "GB", "US", "UM", "UY", "UZ", "VU", "VE", "VN", "VG", "VI", "WF", "EH", "YE", "ZM", "ZW"],
              preferredCountries: userConfig.preferredCountries || null,
              geoCountry: userConfig.geoCountry || null,
              "default": {
                currency: userConfig["default"].currency || null,
                country: userConfig["default"].country || null,
                tel: userConfig["default"].tel || userConfig["default"].country || null
              },
              stylesheet: userConfig.stylesheet,
              translationsJSON: 'https://ca-assets.cerebrospace.net/reg/translations.json',
              translations: userConfig.translations || {},
              ip: userConfig.ip || null,
              googleTagID: userConfig.googleTagID || 'GTM-NPJTQ3J',
              autocomplete: userConfig.hasOwnProperty('autocomplete') && userConfig.autocomplete === 'on' || userConfig.hasOwnProperty('allowAutoComplete') && userConfig.allowAutoComplete === true ? 'on' : 'off',
              errorState: null,
              autoLogin: typeof userConfig.autoLogin === 'undefined' || userConfig.autoLogin !== false,
              rootDomain: 'https://' + "welcome.luckycreek.com".replace(/^(www|welcome|dev|staging|in|stagingin|local)\./gi, ''),
              events: {}
            };
            /*userConfig.returnURL = _self.isValidURL(userConfig.returnURL) ? userConfig.returnURL : null;/**/
  
            var parsedUrlData = _self.parseReturnURL(_self.config.returnURL);
  
            _self.config.returnURL = parsedUrlData.returnURL;
            _self.config.environment = parsedUrlData.environment;
            _self.config.debug = _self.config.environment !== 'production' ? true : userConfig.debug === true;
            var referrer = _self.getQueryParam('referrer') || Cookies.get('referrer.origin', _self.config.cookieDefaults) || document.referrer;
            var defaultLongTermCookieExpiry = new Date(_self.config.currentDate.getTime() + Math.round(1000 * 60 * 60 * 24 * 30));
  
            if (_self.isValidURL(referrer)) {
              _self.config.tracking.referrer = referrer;
              Cookies.set('referrer.origin', referrer, _self.config.cookieDefaults);
  
              _self.setCookie({
                name: 'referrer.origin',
                value: referrer,
                expires: defaultLongTermCookieExpiry
              }).then(function () {
                if (_self.config.debug) {
                  console.info('Cookie set for referrer.origin >>>', referrer);
                }
              });
            }
  
            if (!_self.isValidURL(_self.config.stylesheet)) {
              switch (_self.config.environment) {
                case 'staging':
                  _self.config.stylesheet = 'https://ca-universal.s3.amazonaws.com/reg/staging/default.css';
                  break;
  
                case 'development':
                  _self.config.stylesheet = 'https://ca-universal.s3.amazonaws.com/reg/dev/default.css';
                  break;
  
                case 'production':
                default:
                  _self.config.stylesheet = 'https://ca-assets.cerebrospace.net/reg/dist-1/default.css';
                  break;
              }
            }
  
            _self.callbacks = {
              onRegistrationSuccess: userConfig.onRegistrationSuccess && {}.toString.call(userConfig.onRegistrationSuccess) === '[object Function]' ? userConfig.onRegistrationSuccess : null,
              onRegistrationFailure: userConfig.onRegistrationFailure && {}.toString.call(userConfig.onRegistrationFailure) === '[object Function]' ? userConfig.onRegistrationFailure : null,
              onApiError: userConfig.onApiError && {}.toString.call(userConfig.onApiError) === '[object Function]' ? userConfig.onApiError : null
            };
            window.evtArisRegConfigReady = new CustomEvent('evtArisRegConfigReady');
            window.evtArisRegIovationReady = new CustomEvent('evtArisRegIovationReady');
            window.evtArisRegGeoReady = new CustomEvent('evtArisRegGeoReady');
            window.evtArisRegCurrenciesReady = new CustomEvent('evtArisRegCurrenciesReady');
            window.evtArisRegFormLoaded = new CustomEvent('evtArisRegFormLoaded');
            this.initRollbar(userConfig, function () {
              try {
                _self.getTranslations(function (translations) {
                  _self.config.translations = translations;
  
                  _self.getUserGEO(function () {
                    _self.generateForm(userConfig).then(function () {
                      _self.initFingerprintJS();
  
                      _self.initGoogleTagManager(function () {
                        try {
                          if (!_self.isValidURL(_self.config.tracking.url)) {
                            delete _self.config.tracking.url;
                          }
  
                          _self.parseTracking().then(function (trackingSet) {
                            if (_self.config.debug) {
                              console.info('Successfully parsed tracking >>>', trackingSet);
                            }
                          })["catch"](function (error) {
                            _self.error({
                              level: 'Critical',
                              originalError: error,
                              consoleMessage: 'Failed to parse tracking'
                            });
                          })["finally"](function () {
                            if (!_self.isValidURL(_self.config.tracking.referrer)) {
                              delete _self.config.tracking.referrer;
                            }
  
                            if (_self.config.koreEndpoint === null) {
                              throw new Error('Config for koreEndpoint is required');
                            }
  
                            if (_self.config.brand === null) {
                              throw new Error('Config brand is required');
                            }
  
                            if (!_self.isValidURL(_self.config.returnURL)) {
                              throw new Error('Invalid Return URL: "' + _self.config.returnURL + '"');
                            }
  
                            _self.config.apiEndpoint = 'https://' + _self.config.koreEndpoint + '/v' + _self.config.koreVersion + '/api';
                            new Promise(function (resolve, reject) {
                              try {
                                if (typeof ioGetBlackbox === 'function') {
                                  window.ioBlackBox = ioGetBlackbox();
  
                                  if ((typeof ioBlackBox === "undefined" ? "undefined" : _typeof(ioBlackBox)) === 'object' && ioBlackBox !== null && ioBlackBox.hasOwnProperty('blackbox')) {
                                    _self.config.tracking.iovation = ioBlackBox.blackbox;
                                    window.dispatchEvent(evtArisRegIovationReady);
                                  }
  
                                  resolve();
                                } else if (arisRegistrationVendors.indexOf('blackbox') === -1) {
                                  arisRegistrationVendors.push('blackbox');
                                  window.snareJS = document.createElement('script');
                                  snareJS.src = 'https://mpsnare.iesnare.com/snare.js';
  
                                  snareJS.onload = function () {
                                    window.ioBlackBox = ioGetBlackbox();
                                  ...
                                  document.head.appendChild(snareJS);
                                }
                              } catch (error) {
                                reject(error);
                              }
                              ...
                              try {
                                if (_self.isValidURL(_self.config.stylesheet) && arisRegistrationVendors.indexOf('stylesheet') === -1) {
                                  arisRegistrationVendors.push('stylesheet');
                                  window.regFormCSS = document.createElement('link');
                                  regFormCSS.rel = 'stylesheet';
                                  regFormCSS.href = _self.config.stylesheet;
  
                                  regFormCSS.onload = function () {
                                    window.dispatchEvent(evtArisRegConfigReady);
                                    document.querySelectorAll('[data-aris-registration]').forEach(function (form) {
                                      form.style.opacity = '1.00';
                                    });
                                  };
  
                                  document.head.appendChild(regFormCSS);
                                }
                              } catch (error) {
                                _self.error({
                                  level: 'Warning',
                                  originalError: error,
                                  consoleMessage: 'Failed to load stylesheet for registration form'
                                });
                              }
                            })["catch"](function (error) {
                              _self.error({
                                originalError: error,
                                consoleMessage: 'Failed to load iovation for registration form'
                              });
                            });
                            window.addEventListener('evtArisRegConfigReady', function () {
                              if (_typeof(window['affiliateLandingPage']) === 'object') {
                                var _affiliateLandingPage, _affiliateLandingPage2, _affiliateLandingPage3, _affiliateLandingPage4;
  
                                affiliateLandingPage.config.brand.geoRedirects = (_affiliateLandingPage = (_affiliateLandingPage2 = affiliateLandingPage) === null || _affiliateLandingPage2 === void 0 ? void 0 : (_affiliateLandingPage3 = _affiliateLandingPage2.config) === null || _affiliateLandingPage3 === void 0 ? void 0 : (_affiliateLandingPage4 = _affiliateLandingPage3.brand) === null || _affiliateLandingPage4 === void 0 ? void 0 : _affiliateLandingPage4.geoRedirects) !== null && _affiliateLandingPage !== void 0 ? _affiliateLandingPage : {};
  
                                if (_self.showGeoRedirectPopup({
                                  fromBrand: affiliateLandingPage.config.brand,
                                  toBrand: affiliateLandingPage.config.brands[affiliateLandingPage.config.brand.geoRedirects[_self.config.geoCountry]] || null
                                })) {
                                  return false;
                                }
                              }
  
                              _self.formElement.setAttribute('autocomplete', _self.config.autocomplete);
  
                              _self.formElement.setAttribute('accept-charset', 'CP-1252');
  
                              if (!_self.formElement.classList.contains('c-aris-form')) {
                                _self.formElement.classList.add('c-aris-form');
                              }
  
                              if (!_self.formElement.classList.contains('row')) {
                                _self.formElement.classList.add('row');
                              }
  
                              if (_self.formElement.tagName.toLowerCase() !== 'form') {
                                throw new Error('ARIS registration must be bound to a Form element, but is currently bound to a ' + _self.formElement.tagName.toLowerCase());
                              }
  
                              _self.formElement.setAttribute('data-validation', 'failed');
  
                              _self.publicAuth(function (brandPublicCredentials) {
                                _self.getCurrencies(brandPublicCredentials).then(function () {
                                  _self.calculateDays();
  
                                  var qPs = _self.getQueryParams();
  
                                  if (qPs.hasOwnProperty('aff') && qPs.hasOwnProperty('aff_group')) {
                                    _self.setCookie({
                                      name: 'aff',
                                      value: qPs['aff'],
                                      expires: defaultLongTermCookieExpiry
                                      ...
                                      if (_self.config.debug) {
                                        console.info('Successfully set "aff" cookie >>>', qPs['aff']);
                                      }
                                      ...
                                      _self.setCookie({
                                        ...
                                        if (_self.config.debug) {
                                          console.info('Successfully set "aff_group" cookie >>>', qPs['aff_group']);
                                        }
                                      })["catch"](function (error) {
                                        _self.error({
                                          level: 'Error',
                                          originalError: error,
                                          consoleMessage: 'Failed to set "aff_group" cookie'
                                        });
                                      });
                                    })["catch"](function (error) {
                                      _self.error({
                                        level: 'Error',
                                        originalError: error,
                                        consoleMessage: 'Failed to set "aff" cookie'
                                      });
                                    })["finally"](function () {
                                      _self.bindFormSubmission();
                                    });
                                  } else {
                                    _self.bindFormSubmission();
                                  }
                                  ...
                                  _self.error({
                                    level: 'Critical',
                                    originalError: error,
                                    consoleMessage: 'Failed to build registration form'
                                  });
                                });
                              });
                            });
                ...
                _self.error({
                  level: 'Critical',
                  originalError: error,
                  consoleMessage: 'Failed to build RegJS config'
                });
              }
            });
          } else {
            _self.error({
              level: 'Critical',
              originalError: new Error('Bound form is not a valid HTML Element')
            });
          }
        } catch (error) {
          this.error({
            level: 'Critical',
            originalError: error,
            consoleMessage: 'ARIS registration failed to initialise'
          });
        }
      }
  
      _createClass(arisRegistration, [{
        key: "error",
        value: function error(details) {
          ...
          if (_typeof(this) !== 'object' || !this.hasOwnProperty('config') || !this.config.hasOwnProperty('debug')) {
            init = false;
            debug = true;
          } else {
            init = true;
          ...
          details.level = details.level || 'Error';
          details.originalError = details.originalError || {};
          details.apiError = details.apiError || {};
          details.consoleMessage = details.consoleMessage || details.apiError.message || details.originalError.message || 'Unspecified';
          details.rollbarFailed = details.rollbarFailed === true;
  
          if (debug || details.level === 'Critical') {
            switch (details.level) {
              case 'Critical':
              case 'Error':
                console.error(details.consoleMessage + ' >>>', details);
                break;
  
              case 'Warning':
                if (debug) {
                  console.warn(details.consoleMessage + ' >>>', details);
                }
              ...
              default:
                if (debug) {
                  console.info(details.consoleMessage + ' >>>', details);
                }
          ...
          if (init) {
            this.showInRollbar(details);
  
            if (details.apiError.hasOwnProperty('error') && typeof details.apiError.error === 'string') {
              details.apiError['error_description'] = details.apiError['error_description'] || '';
              details.apiError['error_description'] = this.translate(details.apiError['error_description'], details.apiError['error']);
  
              if (details.apiError.hasOwnProperty('uuid') && typeof details.apiError['uuid'] === 'string' && details.apiError['uuid'].trim().length > 0) {
                details.apiError['error_description'] += '<br/><small>(' + this.translate('Reference') + ': ' + details.apiError['uuid'] + ')</small>';
              }
  
              this.handleApiError(details.apiError);
              this.displayError({
                heading: this.translate('Something Went Wrong'),
                description: details.apiError['error_description']
              });
            }
          }
        }
        ...
        key: "handleApiError",
        value: function handleApiError(apiError) {
          if (apiError.hasOwnProperty('error')) {
        ...
        value: function togglePasswordVisibility(visibilityIcon) {
          var passwordEl = visibilityIcon.parentElement.querySelector('[name="password"]');
          var passwordElType = passwordEl.getAttribute('type');
  
          if (passwordElType === 'password') {
            passwordEl.setAttribute('type', 'text');
            visibilityIcon.classList.add('--visible');
            visibilityIcon.setAttribute('title', 'Hide Password');
          } else {
            passwordEl.setAttribute('type', 'password');
            visibilityIcon.classList.remove('--visible');
            visibilityIcon.setAttribute('title', 'Show Password');
          }
        }
      }, {
        key: "showInRollbar",
        value: function showInRollbar(details) {
          if (_typeof(this.rollbar) === 'object' && this.rollbar !== null && typeof this.rollbar[details.level.toLowerCase()] === 'function' && details.rollbarFailed === false && !this.excludeRollbar(details)) {
            var telemetry = {
              debug: this.config.debug,
              koreEndpoint: this.config.koreEndpoint,
              koreVersion: this.config.koreVersion,
              brand: this.config.brand,
              locale: this.config.locale,
              returnURL: this.config.returnURL,
              playMode: this.config.playMode,
              tracking: this.config.tracking,
              captchaStatus: this.config.captchaStatus,
              recaptchaToken: this.config.recaptchaToken,
              recaptchaId: this.config.recaptchaId,
              brandPublicCredentials: this.config.brandPublicCredentials,
              userData: this.config.userData,
              errorBox: this.config.errorBox,
              currentDate: this.config.currentDate,
              birthDate: this.config.birthDate,
              currencies: this.config.currencies,
              preferredCountries: this.config.preferredCountries,
              geoCountry: this.config.geoCountry,
              "default": this.config["default"],
              stylesheet: this.config.stylesheet,
              translationsJSON: this.config.translationsJSON,
              translations: this.config.translations,
              ip: this.config.ip,
              googleTagID: this.config.googleTagID,
              autocomplete: this.config.autocomplete,
              errorState: this.config.errorState,
              autoLogin: this.config.autoLogin,
              cookies: Cookies.get(null, this.config.cookieDefaults)
            };
  
            if (details.hasOwnProperty('telemetry') && _typeof(details.telemetry) === 'object' && details.telemetry !== null) {
              telemetry = Object.assign(telemetry, details.telemetry);
            }
  
            switch (details.level) {
              case 'Critical':
                this.rollbar.critical(details.consoleMessage, {
                  level: details.level,
                  error: details.apiError || details.originalError,
                  details: telemetry
                });
                break;
  
              case 'Error':
                this.rollbar.error(details.consoleMessage, {
                  level: details.level,
                  error: details.apiError || details.originalError,
                  details: telemetry
                });
              ...
              case 'Warning':
                if (this.config.debug) {
                  this.rollbar.warning(details.consoleMessage, {
                    level: details.level,
                    error: details.apiError || details.originalError,
                    details: telemetry
                  });
              ...
              case 'Info':
                if (this.config.debug) {
                  this.rollbar.info(details.consoleMessage, {
                    level: details.level,
                    error: details.apiError || details.originalError,
                    details: telemetry
                  });
              ...
              case 'Debug':
                if (this.config.debug) {
                  this.rollbar.debug(details.consoleMessage, {
                    level: details.level,
                    error: details.apiError || details.originalError,
                    details: telemetry
                  });
        ...
        key: "excludeRollbar",
        value: function excludeRollbar(details) {
          if (_typeof(details) === 'object' && details !== null) {
            if (details.hasOwnProperty('apiError') && _typeof(details.apiError) === 'object' && details.apiError !== null) {
              if (details.apiError.hasOwnProperty('error')) {
                switch (details.apiError.error) {
        ...
        key: "displayError",
        value: function displayError(details) {
          var _self = this;
  
          try {
            new Promise(function (resolve) {
              _self.config.errorBox.innerHTML = '<h4>' + details.heading + '</h4><p>' + details.description + '</p>';
              setTimeout(function () {
                resolve();
              }, 300);
            }).then(function () {
              if (!_self.config.errorBox.classList.contains('--show')) {
                _self.config.errorBox.classList.add('--show');
              }
            });
          } catch (error) {
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to hide display box'
            });
          }
        }
      }, {
        ...
        value: function hideError() {
          ...
          try {
            new Promise(function (resolve) {
              if (_self.config.errorBox.classList.contains('--show')) {
                _self.config.errorBox.classList.remove('--show');
              }
              ...
              _self.config.errorBox.innerHTML = '';
            });
          } catch (error) {
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to hide error box'
            });
          }
        }
      }, {
        ...
        value: function getTranslations() {
          ...
          try {
            if (this.isValidURL(this.config.translationsJSON)) {
              this.ajax(this.config.translationsJSON).then(function (response) {
              ...
              this.error({
                level: 'Warning',
                originalError: new Error('Invalid translations JSON file'),
                telemetry: {
                  translationsJSON: this.config.translationsJSON
                }
              });
              ...
              if (typeof callback === 'function') {
                callback(this.config.translations);
              }
            }
          } catch (error) {
            this.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Unable to retrieve translations JSON',
              telemetry: {
                translationsJSON: this.config.translationsJSON
              }
            });
        ...
        value: function translate(phrase) {
          ...
          try {
            key = typeof key === 'string' && key.trim() !== '' ? key : phrase;
            var sanitizedKey = key.replace(/[\W_]+/gi, '_').toLowerCase().replace(/(^_+|_+$)/gi, '');
  
            if (this.config.translations.hasOwnProperty(this.config.locale)) {
              if (this.config.translations[this.config.locale].hasOwnProperty(sanitizedKey) && typeof this.config.translations[this.config.locale][sanitizedKey] === 'string' && this.config.translations[this.config.locale][sanitizedKey].trim() !== '') {
                return this.parseTranslationVars(this.config.translations[this.config.locale][sanitizedKey]);
              } else if (this.config.translations[this.config.locale].hasOwnProperty(sanitizedKey.toUpperCase()) && typeof this.config.translations[this.config.locale][sanitizedKey.toUpperCase()] === 'string' && this.config.translations[this.config.locale][sanitizedKey.toUpperCase()].trim() !== '') {
                return this.parseTranslationVars(this.config.translations[this.config.locale][sanitizedKey.toUpperCase()]);
              } else {
                return this.parseTranslationVars(phrase);
              }
            }
  
            this.error({
              level: 'Warning',
              originalError: new Error('Phrase "' + phrase + '" requires translation'),
              telemetry: {
                key: sanitizedKey,
                phrase: phrase,
                locale: this.config.locale,
                availableTranslations: this.config.translations[this.config.locale]
              }
            });
            return this.parseTranslationVars(phrase);
          } catch (error) {
            this.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'ARIS Registration Translation Failure',
              telemetry: {
                key: key,
                phrase: phrase,
                locale: this.config.locale,
        ...
        key: "parseTranslationVars",
        value: function parseTranslationVars(phrase) {
          var _self = this;
  
          try {
            var match = phrase.match(/::\((.+?)+?\)::/gi);
  
            if (Array.isArray(match) && typeof match[0] === 'string') {
              var varOutput;
              var translationVarDetails = {};
              var translationVarString = match[0].replace(/(::\(|\)::)/gi, '');
              var translationVarArray = translationVarString.split(';');
              translationVarDetails.type = translationVarArray[0];
              translationVarDetails.data = {};
  
              if (typeof translationVarArray[1] === 'string') {
                var translationVarRules = translationVarArray[1].split(',');
  
                for (var i = 0; i < translationVarRules.length; i++) {
                  var translationVarRule = translationVarRules[i].split('=');
                  translationVarDetails.data[translationVarRule[0]] = translationVarRule[1];
                }
              }
  
              varOutput = this.parseTranslationVar(translationVarDetails);
              return phrase.replace(/::\((.+?)+?\)::/gi, varOutput);
            }
            ...
            _self.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Failed to parse translation variables'
            });
        ...
        key: "parseTranslationVar",
        value: function parseTranslationVar(translationVarDetails) {
          var _self = this;
  
          try {
            var result = '___';
  
            switch (translationVarDetails.type) {
              case 'link':
                result = '<a';
                var href = '';
  
                if (translationVarDetails.data.hasOwnProperty('root')) {
                  if (translationVarDetails.data.root === 'website') {
                    href += this.config.rootDomain;
                  } else if (translationVarDetails.data.root === 'returnURL') {
                    href += this.config.returnURL;
                  } else {
                    href += window.location.protocol + '//' + "welcome.luckycreek.com";
                  }
                }
  
                if (translationVarDetails.data.hasOwnProperty('path') && typeof translationVarDetails.data.path === 'string') {
                  if (translationVarDetails.data.path[0] === '/') {
                    href += translationVarDetails.data.path;
                  } else {
                    href += '/' + translationVarDetails.data.path;
                  }
                }
                ...
                if (translationVarDetails.data.hasOwnProperty('target') && typeof translationVarDetails.data.target === 'string') {
                  result += ' target="' + translationVarDetails.data.target + '"';
                }
  
                result += '>';
  
                if (translationVarDetails.data.hasOwnProperty('text') && typeof translationVarDetails.data.text === 'string') {
                  result += this.translate(translationVarDetails.data.text);
                }
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to parse translation variable'
            });
        ...
        key: "generateField",
        value: function generateField(fieldName, field) {
          var _self = this;
  
          var fieldHTML = '';
  
          try {
            field.type = field.type || field._tag;
  
            if (field.hasOwnProperty('_class') && typeof field._class === 'string') {
              field._class = field._class[0] === ' ' ? field._class : ' ' + field._class;
            } else if (field._skipIf === true) {
              field._class = '--hidden';
            } else {
              field._class = '';
            }
  
            if (field.type !== 'hidden' && field._tag !== 'div') {
              fieldHTML += '<div class="c-aris-form__field-wrapper --type-' + field.type + field._class + '">';
            }
  
            switch (field._tag) {
              case 'input':
                fieldHTML += '<span class="c-aris-form__field-validation-message --type-' + field.type + '" data-validation-message></span>';
  
                if (field.hasOwnProperty('placeholder')) {
                  field.placeholder = this.translate(field.placeholder);
                }
  
                fieldHTML += '<input class="c-aris-form__field --type-' + field.type + '" name="' + fieldName + '"';
  
                for (var attr in field) {
                  if (field.hasOwnProperty(attr) && attr[0] !== '_') {
                    fieldHTML += ' ' + attr + '="' + field[attr] + '"';
                  }
                }
                ...
                if (field.type === 'password') {
                  fieldHTML += '<span class="c-aris-form__password-visibility" title="Show Password"></span>';
                }
              ...
              case 'select':
                fieldHTML += '<span class="c-aris-form__field-validation-message --type-' + field.type + '" data-validation-message></span>';
                fieldHTML += '<select class="c-aris-form__field --type-' + field.type + '" name="' + fieldName + '"';
  
                for (var _attr in field) {
                  if (field.hasOwnProperty(_attr) && _attr[0] !== '_') {
                    fieldHTML += ' ' + _attr + '="' + field[_attr] + '"';
                  }
                }
              ...
              case 'button':
                if (field.hasOwnProperty('_text')) {
                  field._text = this.translate(field._text);
                } else {
                  field._text = this.translate('Create Account');
                }
  
                if (field.type === 'submit') {
                  fieldHTML += '<div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>';
                }
  
                fieldHTML += '<button class="c-aris-form__button --type-' + field.type + '"';
  
                for (var _attr2 in field) {
                  if (field.hasOwnProperty(_attr2) && _attr2[0] !== '_') {
                    fieldHTML += ' ' + _attr2 + '="' + field[_attr2] + '"';
                  }
                }
  
                fieldHTML += '>' + field._text + '</button>';
                break;
  
              default:
                fieldHTML += '<' + field._tag + ' ';
  
                for (var _attr3 in field) {
                  if (field.hasOwnProperty(_attr3) && _attr3[0] !== '_') {
                    fieldHTML += ' ' + _attr3 + '="' + field[_attr3] + '"';
                  }
                }
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to generate HTML field'
            });
        ...
        key: "invalidWindows1252Chars",
        value: function invalidWindows1252Chars(str) {
          var invalidChars = [];
  
          if (typeof str === 'string') {
            var charlist = "!\"#$%&'()*+,-./0123456789:;=?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_`abcdefghijklmnopqrstuvwxyz{|}~\u20AC\u201A\u0192\u201E\u2026\u2020\u2021\u02C6\u2030\u0160\u2039\u0152\u017D\u2018\u2019\u201C\u201D\u2022\u2013\u2014\u02DC\u2122\u0161\u203A\u0153\u017E\u0178s<>\xA0 ";
  
            for (var i = 0; i < str.length; i++) {
              if (charlist.indexOf(str[i]) < 0 && invalidChars.indexOf(str[i]) < 0) {
        ...
        key: "isValidWindows1252",
        value: function isValidWindows1252(str) {
          if (typeof str !== 'string') {
            return false;
          }
  
          var match = str.match(/^[\t-\r -\[\]-~\xA0-\xAC\xAE-\xFF\u0152\u0153\u0160\u0161\u0178\u017D-\u017F\u0192\u02C6\u02DC\u039C\u1680\u1E9E\u2000-\u200A\u2013\u2014\u2018-\u201A\u201C-\u201E\u2020-\u2022\u2026\u2028\u2029\u202F\u2030\u2039\u203A\u205F\u20AC\u2122\u212A\u212B\u3000\uFEFF]+?$/gim);
        ...
        key: "ajax",
        value: function () {
          var _ajax = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
            var options,
                waitFor,
                _self,
                _args = arguments;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    waitFor = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
                    _self = this;
                    /** @TODO: Figure out cache mechanism **/
                    ...
                    if (options.method === 'POST' && options.body !== null && (_typeof(options.body) === 'object' || Array.isArray(options.body))) {
                      options.body = JSON.stringify(options.body);
                    }
  
                    return _context.abrupt("return", new Promise(function (resolve, reject) {
                      try {
                        if (_self.isValidURL(url)) {
                          if (options.headers.hasOwnProperty('X-Kore-ReturnUrl')) {
                            fetch(url, options).then(function (response) {
                              _self.cacheResponse(url, response, false);
  
                              if (waitFor instanceof Event) {
                                document.dispatchEvent(waitFor);
                              }
                          ...
                          var err = new Error('URL "' + url + '" is not valid');
  
                          _self.error({
                            level: 'Error',
                            originalError: err,
                            consoleMessage: 'URL "' + url + '" is not valid'
                          });
        ...
        key: "addQueryParam",
        value: function addQueryParam(url, paramName, paramValue) {
          var qPs = this.getQueryParams(url);
          var baseURL = url.split('?').shift().replace(/\/+?$/g, '');
          qPs[paramName] = paramValue;
          baseURL += '?';
  
          for (var p in qPs) {
            if (qPs.hasOwnProperty(p)) {
              baseURL += p + '=' + qPs[p] + '&';
            }
          }
        ...
        value: function getQueryParam(param) {
          var qPs = this.getQueryParams();
  
          if (typeof param === 'string' && qPs.hasOwnProperty(param)) {
            return qPs[param];
          }
        ...
        value: function getQueryParams() {
          ...
          url = this.isValidURL(url) ? url : "https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&";
          var qPs = {};
  
          if (url.indexOf('?') > -1) {
            url.split('?').pop().split('&').forEach(function (qP) {
              var qpSplit = qP.split('=');
  
              if (qpSplit.length === 2) {
                qPs[qpSplit[0]] = qpSplit[1];
              }
            });
          }
        ...
        value: function isValidURL(str) {
          try {
            ...
            this.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Failed to to assert valid URL'
            });
            return false;
          }
        }
        ...
        value: function isValidEmail(str) {
          ...
          try {
            ...
            _self.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Failed to to assert valid email address'
            });
        ...
        key: "checkCaptchaStatus",
        value: function checkCaptchaStatus() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  
          var _self = this;
  
          try {
            var brandPublicCredentials = _self.getCookie(_self.config.brand + '.Cred', true);
  
            var captchaStatus = brandPublicCredentials === null || brandPublicCredentials === void 0 ? void 0 : brandPublicCredentials.captcha;
  
            if (typeof captchaStatus === 'undefined') {
              this.ajax(this.config.apiEndpoint + '/auth/player_credentials').then(function (response) {
                response.json().then(function (captchaResponse) {
                  _self.config.captchaStatus = captchaResponse.captcha;
  
                  if (typeof callback === 'function') {
                    callback(_self.config.captchaStatus);
                  }
                });
              });
            } else {
              _self.config.captchaStatus = captchaStatus;
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to check CAPTCHA status via Kore API'
            });
          }
        }
      }, {
        key: "bindIntlTelInput",
        value: function bindIntlTelInput(element) {
          var _self = this;
  
          try {
            this.config.itiNumConfig = {
              utilsScript: 'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.min.js',
              initialCountry: this.config["default"].tel || this.config["default"].country || 'US',
              separateDialCode: true,
              nationalMode: true
            };
  
            if (this.config.countries.length < 248) {
              if (this.config.countries.indexOf(this.config["default"].country) < 0) {
                this.config.countries.unshift(this.config["default"].country);
              }
  
              this.config.itiNumConfig.onlyCountries = this.config.countries;
            }
  
            if (Array.isArray(this.config.preferredCountries) && this.config.preferredCountries.length > 1) {
              if (this.config.preferredCountries.indexOf(this.config["default"].country) < 0) {
                this.config.preferredCountries.unshift(this.config["default"].country);
              }
  
              this.config.itiNumConfig.preferredCountries = this.config.preferredCountries;
            }
  
            this.config.itiNum = intlTelInput(element, this.config.itiNumConfig);
          } catch (error) {
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to bind IntlTelInput to element'
            });
          }
        }
      }, {
        key: "cacheResponse",
        value: function cacheResponse(property, value) {
          var pending = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  
          try {
            window.arisRegistrationCache = arisRegistrationCache || {};
  
            if (window.hasOwnProperty('arisRegistrationCache')) {
              ...
              window.arisRegistrationCache[property] = value;
            }
          } catch (error) {
            this.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Failed to cache property "' + property + '"'
            });
          }
        }
      }, {
        key: "getCachedResponse",
        value: function getCachedResponse(property) {
          ...
          window.arisRegistrationCache = arisRegistrationCache || {};
          var cached = window.hasOwnProperty('arisRegistrationCache') && arisRegistrationCache.hasOwnProperty(property) && arisRegistrationCache[property].hasOwnProperty('_pending');
          return {
            _event: event,
            _pending: cached && arisRegistrationCache[property]['_pending'] === true,
            cached: cached,
            result: cached ? arisRegistrationCache[property]['result'] : null
          };
        }
      }, {
        key: "detectEnv",
        value: function detectEnv() {
          if ("https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&".match(/^https?:\/\/staging(in)?\.(.+?)/gi) !== null || "https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&".match(/^https?:\/\/(.+?)\/staging\//gi) !== null) {
            return 'staging';
          }
  
          if ("https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&".match(/^https?:\/\/(dev|local)\.(.+?)$/gi) !== null || "https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&".match(/^https?:\/\/(.+?)\.capsule/gi) !== null || "https://welcome.luckycreek.com/?offer_id=internalmarketingseo_dec20&TrackingToken=A0W6x4CgVj3hmg95_p7VgWNd7ZgqdRLk&".match(/^https?:\/\/(.+?)\/(dev|development)\//gi) !== null) {
            return 'development';
          }
        ...
        key: "parseReturnURL",
        value: function parseReturnURL(returnURL) {
          var environment = this.detectEnv();
  
          if (typeof returnURL === 'string') {
            returnURL = 'https://' + returnURL.replace(/(^https?:?\/?\/?)+?/gim, '').replace(/\/\//gim, '/').replace(/\/$/gim, '');
  
            if (returnURL.indexOf('https') > -1 && (returnURL.indexOf('local.') > -1 || returnURL.indexOf('.capsule') > -1)) {
              returnURL.replace(/https/gim, 'http');
            }
  
            switch (environment) {
              case 'production':
                returnURL = returnURL.replace(/^(https?:\/\/)(.*?)\./gi, "$1");
                break;
  
              case 'staging':
                returnURL = returnURL.replace(/^(https?:\/\/)(.*?)\./gi, "$1staging.");
                break;
  
              case 'development':
              default:
                if ("welcome.luckycreek.com".indexOf('local.') !== 0 && "welcome.luckycreek.com".indexOf('.capsule') === -1) {
                  returnURL = returnURL.replace(/^(https?:\/\/)(.*?)\./gi, "$1dev.");
                }
            ...
            switch (environment) {
              ...
              case 'staging':
                if ("welcome.luckycreek.com".indexOf('stagingin.') > -1) {
                  subdomain = 'stagingin.';
                } else {
                  subdomain = 'staging.';
                }
              ...
              default:
                if ("welcome.luckycreek.com".indexOf('local.') !== 0 && "welcome.luckycreek.com".indexOf('.capsule') === -1) {
                  subdomain = 'dev.';
                } else if ("welcome.luckycreek.com".indexOf('local.') === 0) {
                  subdomain = 'local.';
                } else {
                  subdomain = '';
                }
            ...
            returnURL = 'https://' + subdomain + "welcome.luckycreek.com".replace(/^(www|staging(in)?|dev|local|welcome|benvenuti|bienvenue|willkommen)?\.?/gi, '');
          }
        ...
        key: "generateForm",
        value: function generateForm(userConfig) {
          var _self = this;
  
          if (userConfig.hasOwnProperty('fields') && _typeof(userConfig.fields) === 'object') {
            _self.config.fields = {
              locale: {
                _tag: 'input',
                type: 'hidden',
                value: _self.config.locale,
                autocomplete: _self.config.autocomplete
              },
              iovation: {
                _tag: 'input',
                type: 'hidden',
            ...
            for (var f in userConfig.fields) {
              if (userConfig.fields.hasOwnProperty(f)) {
                var field = userConfig.fields[f];
  
                if (f !== 'locale' && f !== 'iovation' && field.hasOwnProperty('_tag') && field.hasOwnProperty('type')) {
                  _self.config.fields[f] = field;
                } else {
                  _self.error({
                    originalError: new Error('Custom defined field not valid'),
                    telemetry: {
                      name: f,
                      field: field
                    }
            ...
            _self.config.fields.captcha = {
              _tag: 'div',
              _class: '',
              id: 'g-recaptcha' + '-' + _self.formElement.id.toLowerCase()
            };
            _self.config.fields.submit = {
              _tag: 'button',
            ...
            _self.config.fields = {
              ...
              currency: {
                _tag: 'select',
                _class: '',
                _default: _self.config["default"].currency,
                _skipIf: _self.config.playMode !== 'Real'
              },
              birthdate_day: {
                _tag: 'select',
                _class: '--third',
          ...
          return new Promise(function (resolve) {
            _self.config.footerText = userConfig.footerText || {};
            _self.config.footerText.termsText = _self.config.footerText.termsText || _self.translate('By creating an account I hereby acknowledge that I am above 18 years old and I agree to the ::(link;root=returnURL,path=/terms-and-conditions,target=_blank,text=Terms and Conditions)::', 'default_terms_text');
            _self.config.footerText.accountExistsText = _self.config.footerText.accountExistsText || _self.translate('Already have an account? ::(link;root=returnURL,path=/login,target=_blank,text=Sign In,data-override=login)::', 'default_account_exists_text');
            _self.formElement.innerHTML = '<div class="c-aris-form__error-box" data-aris-registration-error></div>';
  
            for (var _f in _self.config.fields) {
              if (_self.config.fields.hasOwnProperty(_f)) {
                _self.formElement.innerHTML += _self.generateField(_f, _self.config.fields[_f]);
              }
            }
  
            _self.formElement.innerHTML += '<p class="c-aris-form__footer-terms">' + _self.config.footerText.termsText + '</p>';
            _self.formElement.innerHTML += '<p class="c-aris-form__footer-account-exists">' + _self.config.footerText.accountExistsText + '</p>';
            document.querySelectorAll('.c-aris-form__password-visibility').forEach(function (passwordVisibilityElement) {
              passwordVisibilityElement.onclick = function (evt) {
                _self.togglePasswordVisibility(evt.target);
              };
            });
  
            _self.formElement.querySelectorAll('[name]').forEach(function (el) {
              var elementName = el.getAttribute('name');
  
              try {
                if (elementName === 'iovation') {
                  window.addEventListener('evtArisRegIovationReady', function () {
                    el.setAttribute('value', _self.config.tracking.iovation);
                    el.value = _self.config.tracking.iovation;
                  });
                }
  
                if (elementName === 'currency') {
                  window.addEventListener('evtArisRegCurrenciesReady', function () {
                    for (var currencyCode in _self.config.currencies) {
                      if (_self.config.currencies.hasOwnProperty(currencyCode)) {
                        var currency = _self.config.currencies[currencyCode];
                        var currencyOption = document.createElement('option');
                        currencyOption.setAttribute('value', currencyCode);
                        currencyOption.text = currency.name;
  
                        if (typeof currencyCode === 'string') {
                          if (currencyCode.toUpperCase() === 'USD' && (typeof _self.config["default"].currency !== 'string' || !_self.config.currencies.hasOwnProperty(_self.config["default"].currency))) {
                            currencyOption.setAttribute('selected', 'selected');
                          } else if (typeof _self.config["default"].currency === 'string' && currencyCode.toUpperCase() === _self.config["default"].currency.toUpperCase()) {
                            currencyOption.setAttribute('selected', 'selected');
                          }
                        }
  
                        if (el.querySelector('[value="' + currencyCode + '"]') === null) {
                          el.appendChild(currencyOption);
                        }
                      }
                    }
                  });
                ...
                if (el.hasAttribute('type') && el.getAttribute('type') === 'tel') {
                  _self.initIntlTelInput(el);
                }
  
                if (elementName === 'country') {
                  for (var i = 0; i < _self.config.countries.length; i++) {
                    var countryCode = _self.config.countries[i];
                    var countryOption = document.createElement('option');
                    countryOption.setAttribute('value', countryCode);
                    countryOption.text = _self.translate(countryCode);
  
                    if (typeof _self.config["default"].country === 'string' && typeof countryCode === 'string' && countryCode.toUpperCase() === _self.config["default"].country.toUpperCase()) {
                      countryOption.setAttribute('selected', 'selected');
                    }
  
                    el.appendChild(countryOption);
                  }
                }
  
                _self.config.form[elementName] = _self.bindValidation(el);
              } catch (error) {
                _self.error({
                  level: 'Critical',
                  originalError: error,
                  consoleMessage: 'Failed to generate form field for ' + elementName,
                  rollbarFailed: true
                });
              }
            });
  
            _self.config.form._validationStatus = false;
            _self.config.errorBox = _self.formElement.querySelector('[data-aris-registration-error]');
            resolve(_self.formElement);
          });
        }
      }, {
        key: "initRollbar",
        value: function initRollbar() {
          ...
          try {
            ...
            if (_self.rollbar === null && (!window.hasOwnProperty('Rollbar') || _typeof(window.Rollbar) !== 'object')) {
              __webpack_require__.e(/*! import() | rollbar */ "rollbar").then(__webpack_require__.t.bind(__webpack_require__, /*! rollbar */ "./node_modules/rollbar/dist/rollbar.umd.min.js", 23)).then(function (RollbarModule) {
                _self.rollbar = new RollbarModule["default"]({
                  accessToken: '342e131d8b6e4c38a3acd2bde3d5ff82',
                  captureUncaught: false,
                  captureUnhandledRejections: false,
                  ignoreDuplicateErrors: true,
                  includeItemsInTelemetry: true,
                  ignoredMessages: ['/(chrome-extension:\/\/)/gim'],
                  verbose: true,
                  payload: {
                    environment: _self.config.environment,
                    server: {
                      host: "welcome.luckycreek.com"
                    }
                  }
                });
              })["catch"](function (error) {
                _self.error({
                  level: 'Critical',
                  originalError: error,
                  consoleMessage: 'Failed to import Rollbar',
                  rollbarFailed: true
                });
              })["finally"](function () {
                if (typeof callback === 'function') {
            ...
            } else if (window.hasOwnProperty('Rollbar') && _typeof(window.Rollbar) === 'object') {
              _self.rollbar = new Rollbar({
                accessToken: '342e131d8b6e4c38a3acd2bde3d5ff82',
                captureUncaught: false,
                captureUnhandledRejections: false,
                ignoreDuplicateErrors: true,
            ...
            this.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to init Rollbar',
              rollbarFailed: true
            });
        ...
        key: "initGoogleTagManager",
        value: function initGoogleTagManager() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
          ...
          try {
            if (arisRegistrationVendors.indexOf('gtag') === -1) {
              arisRegistrationVendors.push('gtag');
              var googleTagScript = document.createElement('script');
              var googleTagNoScript = document.createElement('noscript');
              googleTagScript.innerHTML = "<!-- Google Tag Manager -->\n\t                (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\n\t                new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\n\t                j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n\t                'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);\n\t                })(window,document,'script','dataLayer','" + this.config.googleTagID + "');\n\t                <!-- End Google Tag Manager -->";
              googleTagNoScript.innerHTML = "<!-- Google Tag Manager (noscript) -->\n    <iframe src=\"https://www.googletagmanager.com/ns.html?id=" + this.config.googleTagID + "\" height=\"0\" width=\"0\" style=\"display:none;visibility:hidden\"></iframe>\n    <!-- End Google Tag Manager (noscript) -->";
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to init Google Tag Manager'
            });
          }
        ...
        key: "pushGoogleTagEvent",
        value: function pushGoogleTagEvent(eventName) {
          var onceOff = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  
          if (typeof eventName === 'string') {
            if (onceOff && Number.isInteger(this.config.events[eventName]) && this.config.events[eventName] > 0) {
              return false;
            }
  
            var gtagEvent;
            gtagEvent = dataLayer.push({
              event: eventName
            });
            ...
            if (gtagEvent !== true) {
              this.error({
                level: 'Warning',
                originalError: new Error('Failed to push Google Tag Event: "' + eventName + '"')
              });
              return false;
            } else {
              this.config.events[eventName] = Number.isInteger(this.config.events[eventName]) ? this.config.events[eventName] + 1 : 1;
              return true;
            }
          }
        ...
        value: function initIntlTelInput(element) {
          var _self = this;
  
          try {
            if (typeof intlTelInput === 'function') {
              this.bindIntlTelInput(element);
            } else if (arisRegistrationVendors.indexOf('intl') === -1) {
              arisRegistrationVendors.push('intl');
              window.intlTelInputCss = document.createElement('link');
              intlTelInputCss.rel = 'stylesheet';
              intlTelInputCss.href = 'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/css/intlTelInput.min.css';
              window.intlTelInputScript = document.createElement('script');
              ...
              intlTelInputScript.onload = function () {
                _self.bindIntlTelInput(element);
              };
  
              intlTelInputCss.onload = function () {
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to init IntlTelInput'
            });
          }
        }
      }, {
        ...
        value: function resetRecaptcha() {
          ...
          try {
            ...
            if ((typeof grecaptcha === "undefined" ? "undefined" : _typeof(grecaptcha)) === 'object' && grecaptcha !== null && typeof ((_grecaptcha = grecaptcha) === null || _grecaptcha === void 0 ? void 0 : _grecaptcha.reset) === 'function' && id !== null) {
              grecaptcha.reset(id);
            } else {
              this.initRecaptcha();
            }
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to reset reCAPTCHA'
            });
          }
        }
      }, {
        ...
        value: function initRecaptcha() {
          ...
          try {
            this.checkCaptchaStatus(function (captchaStatus) {
              if (captchaStatus.type.toLowerCase() !== 'none') {
                _self.waitFor('grecaptcha', function () {
                  _self.recaptchaLoaded();
                }, function () {
                  window.recaptchaScript = document.createElement('script');
                  recaptchaScript.src = encodeURI("https://www.google.com/recaptcha/api.js?onload=recaptchaLoaded&render=explicit&hl=" + _self.config.locale.split('-')[0]);
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to initialise reCAPTCHA'
            });
          }
        }
      }, {
        ...
        value: function recaptchaLoaded() {
          ...
          try {
            var _self$config$captchaS;
  
            if (typeof ((_self$config$captchaS = _self.config.captchaStatus) === null || _self$config$captchaS === void 0 ? void 0 : _self$config$captchaS.site_key) !== 'undefined') {
              var id = 'g-recaptcha' + '-' + _self.formElement.id.toLowerCase();
  
              _self.waitFor('#' + id, function () {
                _self.config.recaptchaId = grecaptcha.render(id, {
                  'sitekey': _self.config.captchaStatus.site_key,
                  'callback': function callback(recaptchaToken) {
                    _self.recaptchaVerified(recaptchaToken, _self);
                  },
                  'expired-callback': function expiredCallback(recaptchaToken) {
                    _self.resetRecaptcha(recaptchaToken.recaptchaId);
  
                    _self.refreshValidation();
                  }
                });
              }, function () {});
            }
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'reCAPTCHAv2 failed to load'
            });
          }
        }
      }, {
        key: "recaptchaVerified",
        value: function recaptchaVerified(recaptchaToken, instance) {
          var _self = this;
          ...
          try {
            if (typeof recaptchaToken !== 'string') {
              ...
              instance.config.recaptchaToken = recaptchaToken;
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to verify reCAPTCHA token'
            });
  
            _self.resetRecaptcha(instance.recaptchaId);
        ...
        value: function credentialsExpired() {
          var credentials = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  
          try {
            if (_typeof(credentials) === 'object' && credentials !== null && credentials.hasOwnProperty('tokens')) {
              var now = new Date();
              var expiryDate, accessToken;
              accessToken = this.getBearerToken(credentials);
              expiryDate = new Date(accessToken.expiration);
              var credLifespan = expiryDate.getTime() - 60000 - now.getTime();
              return credLifespan < 0;
            } else {
              return true;
            }
          } catch (error) {
            return _typeof(credentials) === 'object' && credentials !== null && credentials.hasOwnProperty('tokens');
          }
        }
      }, {
        key: "getBearerToken",
        value: function getBearerToken() {
          ...
          try {
            credentials = credentials || this.getCookie(this.config.brand + '.Cred', true);
  
            if (_typeof(credentials) === 'object' && credentials !== null && credentials.hasOwnProperty('tokens') && Array.isArray(credentials.tokens)) {
              return credentials.tokens.find(function (token) {
        ...
        key: "publicAuth",
        value: function publicAuth() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  
          var _self = this;
  
          var cookieExpiry = new Date(_self.config.currentDate.getTime() + Math.round(1000 * 60 * 60 * 24 * 30));
          ...
          try {
            ...
            if (_self.credentialsExpired(brandPublicCredentials)) {
              this.ajax(this.config.apiEndpoint + '/auth/brand_public_credentials/token', {
                method: 'POST',
                mode: 'cors',
                cache: 'no-cache',
                referrerPolicy: 'origin',
                headers: {
                  'X-Kore-ReturnUrl': _self.config.returnURL,
                  'Content-Type': 'application/json'
                },
                body: JSON.stringify({
                  brand_id: _self.config.brand,
                  locale: _self.config.locale,
                  tracking: _self.config.tracking,
                  ip: _self.config.ip
                })
              }).then(function (response) {
                if (response.status >= 200 && response.status < 300) {
                  response.json().then(function (brandPublicCredentials) {
                    brandPublicCredentials.bearer_token = _self.getBearerToken(brandPublicCredentials);
                    _self.config.brandPublicCredentials = brandPublicCredentials;
  
                    var trackingCookieValue = _self.getCookie('kore.tracking');
  
                    if (typeof trackingCookieValue === 'string') trackingCookieValue = trackingCookieValue.replace(/^ma-/gi, '');
  
                    if (brandPublicCredentials.hasOwnProperty('tracking_id') || trackingCookieValue !== null) {
                      var _brandPublicCredentia;
  
                      // milliseconds * seconds * minutes * hours * days
                      _self.config.tracking.tracking_id = (_brandPublicCredentia = brandPublicCredentials === null || brandPublicCredentials === void 0 ? void 0 : brandPublicCredentials.tracking_id) !== null && _brandPublicCredentia !== void 0 ? _brandPublicCredentia : trackingCookieValue;
                      _self.config.tracking.tracking_id = _self.config.tracking.tracking_id.replace(/^ma-/gi, '');
  
                      _self.updateWindowConfig();
  
                      _self.setCookie({
                        name: 'kore.tracking',
                        value: _self.config.tracking.tracking_id,
                        expires: cookieExpiry
                      }).then(function () {
                        if (typeof callback === 'function') {
                          callback(brandPublicCredentials);
                        }
                      })["catch"](function (error) {
                        var errorMsg = 'Failed to set kore.tracking cookie';
  
                        if (error.hasOwnProperty('error') && error.error.hasOwnProperty('message') && typeof error.error.message === 'string') {
                  ...
                  response.json().then(function (error) {
                    ...
                    if (error.hasOwnProperty('error')) {
                      errorDetails.consoleMessage = error.error.replace(/_+?/gi, ' ').toUpperCase();
                    }
  
                    if (error.hasOwnProperty('error_description')) {
                      errorDetails.consoleMessage += ': ' + error.error_description;
                    }
  
                    _self.error(errorDetails);
                  });
                }
              });
            } else {
              ...
              if (typeof callback === 'function') {
                callback(_self.config.brandPublicCredentials);
              }
            }
          } catch (error) {
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to obtain Brand Public Credentials'
            });
          }
        }
      }, {
        key: "getCurrencies",
        value: function getCurrencies(brandPublicCredentials) {
          var _self = this;
  
          try {
            return this.ajax(this.config.apiEndpoint + '/currencies', {
              method: 'GET',
              mode: 'cors',
              referrerPolicy: 'origin',
              headers: {
                'X-Kore-ReturnUrl': _self.config.returnURL,
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + brandPublicCredentials.bearer_token.value
              }
            }).then(function (response) {
              if (response.status === 401) {
                return _self.nukeTheCookies(function () {
                  return _self.publicAuth(function (freshCredentials) {
                    return _self.getCurrencies(freshCredentials);
                  });
                });
              } else {
                return response.json().then(function (currenciesResponse) {
                  var currencies = {};
  
                  for (var i = 0; i < currenciesResponse.currencies.length; i++) {
                    var currencyCode = currenciesResponse.currencies[i]['currency'];
                    currencies[currencyCode] = {
                      code: currencyCode,
                      name: _self.translate(currencyCode)
                    };
                  }
  
                  if (Object.keys(_self.config.currencies).length === 0) {
                    _self.config.currencies = currencies;
                  } else {
                    for (var code in currencies) {
                      if (_self.config.currencies.hasOwnProperty(code)) {
                        _self.config.currencies[code]['code'] = code;
                        _self.config.currencies[code]['name'] = _self.translate(_self.config.currencies[code]['name'], code);
                      }
                    }
  
                    for (var _code in _self.config.currencies) {
                      if (!currencies.hasOwnProperty(_code)) {
                        delete _self.config.currencies[_code];
                      }
                    }
                  }
  
                  window.dispatchEvent(evtArisRegCurrenciesReady);
                  return _self.config.currencies;
                });
              }
            });
          } catch (error) {
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to get currencies from endpoint'
            });
          }
        }
      }, {
        key: "nukeTheCookies",
        value: function nukeTheCookies(callback) {
          var _self = this;
  
          _self.removeCookie({
            name: _self.config.brand + '.Cred'
          }).then(function () {
            _self.removeCookie({
              name: _self.config.brand + '.User'
            }).then(function () {
              _self.removeCookie({
                name: _self.config.brand + '.Actions'
              }).then(function () {
                _self.removeCookie({
                  name: _self.config.brand + '.Cashier'
                }).then(function () {// All cookies removed
                })["catch"](function (error) {
                  _self.error({
                    originalError: error,
                    consoleMessage: 'Failed remove Cashier Cookie. Nuke cookies has failed.'
                  });
                });
              })["catch"](function (error) {
                _self.error({
                  originalError: error,
                  consoleMessage: 'Failed remove Actions Cookie. Nuke cookies has failed.'
                });
              });
            })["catch"](function (error) {
              _self.error({
                originalError: error,
                consoleMessage: 'Failed remove User Cookie. Nuke cookies has failed.'
              });
            });
          })["catch"](function (error) {
            _self.error({
              originalError: error,
              consoleMessage: 'Failed remove Cred Cookie. Nuke cookies has failed.'
            });
          })["finally"](function () {
            if (typeof callback === 'function') {
              callback();
        ...
        key: "setCookie",
        value: function setCookie(data) {
          var _self = this;
  
          return new Promise(function (resolve, reject) {
            try {
              var cookieMeta = Object.assign(_self.config.cookieDefaults, {
                expires: data.expires || 1
              });
              data.value = data.value || null;
  
              if (data.hasOwnProperty('name') && typeof data.name === 'string' && data.name.trim().length > 0) {
                Cookies.set(data.name, data.value, cookieMeta);
                var cookieValue = Cookies.get(data.name, cookieMeta);
                resolve(cookieValue);
              } else {
                var error = new Error('Cookie name "' + data.name + '" is invalid');
  
                _self.error({
                  originalError: error,
                  consoleMessage: 'Failed to set cookie. Cookie name is invalid.'
                });
              ...
              _self.error({
                originalError: error,
                consoleMessage: 'Failed to set cookie "' + data.name + '"'
              });
        ...
        value: function getCookie(cookieName) {
          var getJSON = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  
          try {
            if (getJSON) {
              return Cookies.getJSON(cookieName, this.config.cookieDefaults) || null;
            }
  
            return Cookies.get(cookieName, this.config.cookieDefaults) || null;
          } catch (error) {
            return null;
          }
        }
        ...
        key: "removeCookie",
        value: function removeCookie(data) {
          var _self = this;
  
          return new Promise(function (resolve, reject) {
            try {
              if (data.hasOwnProperty('name') && typeof data.name === 'string' && data.name.trim().length > 0) {
                if (data.hasOwnProperty('attributes') && _typeof(data.attributes) === 'object') {
                  Cookies.remove(data.name, Object.assign(_self.config.cookieDefaults, data.attributes));
                } else {
                  Cookies.remove(data.name, _self.config.cookieDefaults);
                }
                ...
                _self.error({
                  originalError: error,
                  consoleMessage: 'Failed to remove cookie. Cookie name is invalid.'
                });
              ...
              _self.error({
                originalError: error,
                consoleMessage: 'Failed to remove cookie "' + data.name + '"'
              });
        ...
        key: "initFingerprintJS",
        value: function initFingerprintJS() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  
          var _self = this;
  
          try {
            if (typeof Fingerprint === 'undefined' && arisRegistrationVendors.indexOf('fingerprint') === -1 && localStorage.getItem('visitorId') === null) {
              arisRegistrationVendors.push('fingerprint'); // Initialize the agent at application startup.
              ...
              new Promise(function (resolve, reject) {
                ...
                if (typeof _self.config.fpjs.token === 'string' && _self.isValidURL(_self.config.fpjs.endpoint)) {
                  _self.config.fpjs.fpPromise = FingerprintJS.load({
                    token: _self.config.fpjs.token,
                    endpoint: _self.config.fpjs.endpoint
                  })["catch"](function (error) {
                    _self.error({
                      level: 'Error',
                      originalError: error,
                      consoleMessage: 'Failed to load FingerprintJS promise'
                    });
                  ...
                  _self.config.fpjs.fpPromise.then(function (fp) {
                    return fp.get();
                  }).then(function (result) {
                    var _result$visitorId;
  
                    var visitorId = (_result$visitorId = result === null || result === void 0 ? void 0 : result.visitorId) !== null && _result$visitorId !== void 0 ? _result$visitorId : null;
                ...
                _self.error({
                  level: 'Error',
                  originalError: error,
                  consoleMessage: 'Failed to inject FingerprintJS script'
                });
            ...
            _self.error({
              level: 'Error',
              originalError: error,
              consoleMessage: 'Failed to initialize FingerprintJS'
            });
        ...
        key: "getUserGEO",
        value: function getUserGEO() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  
          var _self = this;
  
          try {
            if (!_self.isValidIP(_self.config.ip) || _self.config.geoCountry === null) {
              _self.ajax('https://www.cloudflare.com/cdn-cgi/trace').then(function (response) {
                response.text().then(function (body) {
                  var ipMatch = body.match(/ip=(.+?)\n/gi);
  
                  if (Array.isArray(ipMatch) && typeof ipMatch[0] === 'string') {
                    var ip = ipMatch[0].split('=')[1];
                  ...
                  var locMatch = body.match(/loc=(.+?)\n/gi);
  
                  if (Array.isArray(locMatch) && typeof locMatch[0] === 'string') {
                    var loc = locMatch[0].split('=')[1];
  
                    if (typeof loc === 'string' && loc.trim().length === 2 && _self.config.geoCountry === null) {
                      _self.config.geoCountry = loc.trim().toUpperCase();
  
                      if (_self.config["default"].country === null) {
                        _self.config["default"].country = _self.config.geoCountry;
                      }
  
                      _self.detectDefaultCurrencyByCountry(_self.config["default"].country);
                    }
                  }
  
                  window.dispatchEvent(evtArisRegGeoReady);
  
                  if (typeof callback === 'function') {
                    callback({
                      country: _self.config.geoCountry,
                      ip: _self.config.ip
                    });
                  }
                });
              ...
              if (!_self.isValidIP(_self.config.ip)) {
                _self.config.ip = null;
              }
            ...
            if (_self.config["default"].country === null) {
              if (Array.isArray(_self.config.countries && _self.config.countries.length > 0)) {
                _self.config["default"].country = _self.config.countries.indexOf('US') > -1 ? 'US' : _self.config.countries[0];
              } else {
                _self.config["default"].country = 'US';
              }
            }
  
            if (_self.config.geoCountry === null) {
              _self.config.geoCountry = _self.config["default"].country;
            }
        ...
        key: "bindToRegDate",
        value: function bindToRegDate(field) {
          var _self = this;
  
          try {
            switch (field['data-date']) {
              case 'year':
                var yearOption = document.createElement('option');
                yearOption.setAttribute('value', '');
                yearOption.text = 'Year';
  
                field._el.appendChild(yearOption);
  
                for (var i = 1900; i <= this.config.currentDate.getFullYear(); i++) {
                  yearOption = document.createElement('option');
                  yearOption.setAttribute('value', i.toString());
                  yearOption.text = i.toString();
                  /* if (i === this.config.birthDate.getFullYear()) {
                ...
                field._el.onchange = function () {
                  var el = this;
                  new Promise(function (resolve) {
                    _self.config.birthDate.setDate(1);
  
                    _self.config.birthDate.setFullYear(parseInt(el.value));
  
                    resolve(_self.config.birthDate);
                  }).then(function (birthDate) {
                    _self.calculateDays(birthDate);
                  });
                };
              ...
              case 'month':
                ...
                field._el.appendChild(monthOption);
  
                for (var _i = 0; _i < 12; _i++) {
                  monthOption = document.createElement('option');
                  monthOption.setAttribute('value', _i.toString());
                  monthOption.text = this.translate(this.config.months[_i]);
                ...
                field._el.onchange = function () {
                  ...
                  new Promise(function (resolve) {
                    ...
                    _self.config.birthDate.setMonth(parseInt(el.value));
              ...
              case 'day':
                field._el.onchange = function () {
                  _self.config.birthDate.setDate(parseInt(this.value));
                };
            ...
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to bind birth date inputs'
            });
          }
        }
      }, {
        key: "birthdateElementCreated",
        value: function birthdateElementCreated() {
          return _typeof(this.config) === 'object' && this.config !== null && _typeof(this.config.form) === 'object' && this.config.form !== null && _typeof(this.config.form.hasOwnProperty('birthdate_day')) && _typeof(this.config.form.hasOwnProperty('birthdate_month')) && _typeof(this.config.form.hasOwnProperty('birthdate_year')) && _typeof(this.config.form['birthdate_day']) === 'object' && this.config.form['birthdate_day'] !== null && _typeof(this.config.form['birthdate_month']) === 'object' && this.config.form['birthdate_month'] !== null && _typeof(this.config.form['birthdate_year']) === 'object' && this.config.form['birthdate_year'] !== null;
        }
      }, {
        key: "calculateDays",
        value: function calculateDays() {
          var birthDate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
          ...
          try {
            ...
            var currentValue = 1;
            new Promise(function (resolve, reject) {
              if (!_self2.config.form.hasOwnProperty('birthdate_day') || !_self2.config.form['birthdate_day'].hasOwnProperty('_el')) {
                reject('no_birthdate_day_field');
              } else {
                daysInMonth = new Date(_self2.config.birthDate.getFullYear(), _self2.config.birthDate.getMonth() + 1, 0).getDate();
                currentValue = _self2.birthdateElementCreated() ? parseInt(_self2.config.form['birthdate_day']._el.value) : 1;
                ...
                if (currentValue > daysInMonth) {
                  currentValue = daysInMonth;
                }
  
                if (_self2.birthdateElementCreated()) {
                  while (_self2.config.form['birthdate_day']._el.lastElementChild) {
                    _self2.config.form['birthdate_day']._el.removeChild(_self2.config.form['birthdate_day']._el.lastElementChild);
                  }
                }
              ...
              _self2.config.form['birthdate_day']._el.appendChild(dayOption);
  
              for (var i = 1; i <= daysInMonth; i++) {
                dayOption = document.createElement('option');
                dayOption.setAttribute('value', i.toString());
                ...
                if (Number.isInteger(currentValue)) {
                  _self2.config.birthDate.setDate(currentValue);
                }
              }
  
              _self2.refreshValidation();
            })["catch"](function () {
              console.info('Day calculation skipped. No birthdate day field in form >>>', _self2.config.form);
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to calculate days on date change'
            });
          }
        }
      }, {
        key: "bindValidation",
        value: function bindValidation(element) {
          var _self = this;
          ...
          try {
            for (var a in element.attributes) {
              if (element.attributes.hasOwnProperty(a)) {
            ...
            if (field.hasOwnProperty('data-date')) {
              _self.bindToRegDate(field);
            }
  
            element.addEventListener('click', function () {
              _self.validateField(field);
            });
            element.addEventListener('change', function () {
              _self.validateField(field);
  
              if (field.name === 'country') {
                _self.adjustCurrencyAndDialCodeByCountry(element.value);
              }
            });
            element.addEventListener('keyup', function () {
              _self.validateField(field);
  
              _self.pushGoogleTagEvent('reg_input_started', true);
            });
            ...
            _self.error({
              originalError: error,
              consoleMessage: 'Failed to bind validation to field'
            });
          }
        }
      }, {
        key: "refreshValidation",
        value: function refreshValidation() {
          var _self = this;
  
          try {
            this.config.form._validationStatus = true;
  
            for (var fieldName in this.config.form) {
              if (this.config.form.hasOwnProperty(fieldName) && this.config.form[fieldName][0] !== '_') {
                var validatedField = this.config.form[fieldName];
  
                if (validatedField.type === 'select') {
                  if (typeof validatedField['_el'].value === 'undefined' || validatedField['_el'].value === '') {
                  ...
                  this.parseValidationStyles(validatedField, validatedField.validation);
                }
  
                if (Object.keys(this.config.fields).indexOf(fieldName) === -1) {
                  if (_typeof(validatedField) !== 'object') {
                    validatedField = {};
                  }
                ...
                if (_typeof(validatedField) === 'object' && validatedField.hasOwnProperty('validation') && validatedField.validation.hasOwnProperty('status') && validatedField.validation.status === false) {
                  this.config.form._validationStatus = false;
                } else if (_typeof(validatedField) === 'object' && validatedField.type !== 'hidden' && !validatedField.hasOwnProperty('validation')) {
                  this.config.form._validationStatus = false;
                }
              }
            }
  
            if (this.config.captchaStatus !== null && this.config.captchaStatus.type !== 'none' && this.config.recaptchaToken === null) {
              if (this.config.form._validationStatus === true) {
                throw new Error('reCAPTCHA Unsuccessful', {
                  recaptchaStatus: this.config.recaptchaStatus,
                  recaptchaToken: this.config.recaptchaToken
                });
              }
            ...
            if (this.config.form._validationStatus === true) {
              ...
              _self.formElement.setAttribute('data-validation', 'passed');
  
              _self.formElement.querySelector('button[type="submit"]').removeAttribute('disabled');
            } else {
              _self.formElement.setAttribute('data-validation', 'failed');
  
              _self.formElement.querySelector('button[type="submit"]').setAttribute('disabled', 'disabled');
            }
          } catch (error) {
            _self.error({
              originalError: error,
              consoleMessage: 'Google reCAPTCHAv2 failed to verify'
            });
  
            if (error.message === 'reCAPTCHA Unsuccessful') {
              this.displayError({
                heading: this.translate(error.message),
                description: this.translate("Please check I'm not a robot, to continue")
              });
            }
          }
        }
      }, {
        key: "itiNumValidationMessage",
        value: function itiNumValidationMessage(errorCode) {
          var msg;
  
          switch (errorCode) {
            case 0:
              if (this.config.itiNum.isValidNumber() === true) {
                msg = '';
              } else {
        ...
        key: "parseValidationStyles",
        value: function parseValidationStyles(field, validation) {
          var _self = this;
  
          try {
            var parentElement = field._el.parentElement;
  
            while (parentElement.classList.contains('iti')) {
              parentElement = parentElement.parentElement;
            }
  
            var validationMessageSpan = parentElement.querySelector('[data-validation-message]');
  
            if (validation.status === true) {
              validationMessageSpan.innerHTML = validation.message;
  
              if (field._el.classList.contains('--invalid')) {
                field._el.classList.remove('--invalid');
              }
              ...
              validationMessageSpan.classList.remove('--invalid');
  
              field._el.classList.add('--valid');
  
              parentElement.classList.add('--valid');
              validationMessageSpan.classList.add('--valid');
            } else {
              validationMessageSpan.innerHTML = validation.message;
  
              if (field._el.classList.contains('--valid')) {
                field._el.classList.remove('--valid');
              }
  
              if (parentElement.classList.contains('--valid')) {
                parentElement.classList.remove('--valid');
              }
  
              validationMessageSpan.classList.remove('--valid');
  
              field._el.classList.add('--invalid');
  
              parentElement.classList.add('--invalid');
              validationMessageSpan.classList.add('--invalid');
            }
          } catch (error) {
            _self.error({
              originalError: error
        ...
        value: function validateField(field) {
          ...
          try {
            new Promise(function (resolve) {
              ...
              if (field.hasOwnProperty('required') && field.required !== 'false' && field.required !== false) {
                if (typeof field._el.value === 'undefined' || field._el.value === null || field._el.value.trim() === '') {
                  validation.status = false;
                  validation.message = _self.translate('This field is required');
                  resolve(validation);
                }
              }
  
              if (field.hasOwnProperty('minlength')) {
                if (field._el.value.length < parseInt(field.minlength)) {
                  validation.status = false;
                  validation.message = _self.translate('Minimum characters') + ': ' + field.minlength;
                  resolve(validation);
                }
              }
  
              if (field.hasOwnProperty('maxlength')) {
                if (field._el.value.length > parseInt(field.maxlength)) {
                  validation.status = false;
                  validation.message = _self.translate('Maximum characters') + ': ' + field.maxlength;
                  resolve(validation);
                }
              }
  
              if (typeof field._el.value === 'string') {
                var invalidChars = _self.invalidWindows1252Chars(field._el.value);
  
                if (invalidChars.length > 0) {
                  validation.status = false;
                  validation.message = _self.translate('Invalid characters used') + ': ' + invalidChars.join(', ');
                }
              }
  
              switch (field.type) {
                case 'email':
                  if (!_self.isValidEmail(field._el.value)) {
                    validation.status = false;
                    validation.message = _self.translate('Not a valid email address');
                    resolve(validation);
                  }
                ...
                case 'tel':
                  if (!_self.config.itiNum.isValidNumber()) {
                    validation.status = false;
                    validation.message = _self.translate(_self.itiNumValidationMessage(_self.config.itiNum.getValidationError()));
                  }
  
                  if (field._el.value.match(/^\+?[0-9]+$/gi) === null) {
                    validation.status = false;
                    validation.message = _self.translate('Please use digits only');
                  }
              ...
              if (typeof field._el.value === 'string' && field._el.value.length > 0 && !_self.isValidWindows1252(field._el.value)) {
                validation.status = false;
                validation.message = _self.translate('Unsupported Characters Used');
              }
              ...
              if (field.hasOwnProperty('data-date')) {
                _self.config.form['birthdate_year']['validation'] = validation;
  
                _self.parseValidationStyles(_self.config.form['birthdate_year'], validation);
  
                _self.config.form['birthdate_month']['validation'] = validation;
  
                _self.parseValidationStyles(_self.config.form['birthdate_month'], validation);
  
                _self.config.form['birthdate_day']['validation'] = validation;
  
                _self.parseValidationStyles(_self.config.form['birthdate_day'], validation);
              } else {
                _self.config.form[field.name] = field;
  
                _self.parseValidationStyles(field, validation);
              }
            ...
            _self.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Field Validation Failed'
            });
          }
        }
      }, {
        key: "getDataFromClipboard",
        value: function getDataFromClipboard(callback) {
          navigator.clipboard.readText().then(function (data) {
            var result = JSON.parse(data);
            console.info('Retrieving data from clipboard >>>', result);
        ...
        key: "autoFillRegForm",
        value: function autoFillRegForm() {
          var _this = this;
  
          var fromClipBoard = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
          ...
          try {
            ...
            if (fromClipBoard) {
              ...
              this.getDataFromClipboard(function (data) {
                _self.autoFillRegForm(false, data);
              });
              return false;
            } else {
              data = {
                email: data.email || 'at' + date.getTime() + '@autotest.com',
                password: data.password || '123456789',
                nickname: data.nickname || 'AT' + date.getTime(),
                firstname: data.firstname || 'Auto',
                lastname: data.lastname || 'Test',
                currency: data.currency || 'USD',
                contact: data.contact || '+12035458000',
                country: data.country || 'US',
                birthdate_day: data.birthdate_day || '5',
                birthdate_month: data.birthdate_month || '10',
                birthdate_year: data.birthdate_year || '1984'
              };
              ...
              var _loop = function _loop(name) {
                if (data.hasOwnProperty(name)) {
                  ...
                  if (arisRegistration.hasOwnProperty('koreRegisterForm_home')) {
                    el = arisRegistration['koreRegisterForm_home'].formElement.querySelector('[name="' + name + '"]');
                  } else {
                    el = _this.formElement.querySelector('[name="' + name + '"]');
                  }
  
                  if (el instanceof HTMLElement) {
                    if (el.tagName.toLowerCase() === 'select') {
                      el.getElementsByTagName('option').forEach(function (option) {
                        if (option.getAttribute('value') === data[name]) {
                    ...
                    if (el.name === 'contact') {
                      var changeDialCode = new Event('keyup');
                      el.dispatchEvent(changeDialCode);
                    }
  
                    var triggerValidation = new Event('click');
                    el.dispatchEvent(triggerValidation);
                  }
                }
              };
              ...
              console.info('Saving data to clipboard >>>', result);
              navigator.clipboard.writeText(result).then(function () {
                alert('Registration form has been autofilled and data copied to clipboard');
              }, function () {
                alert('Registration form has been autofilled, but data was not copied to clipboard');
              });
              return true;
            }
          } catch (error) {
            this.error({
              originalError: error,
              consoleMessage: 'Failed to autofill registration with keyboard shortcuts'
            });
            return false;
          }
        }
      }, {
        key: "bindFormSubmission",
        value: function bindFormSubmission() {
          var _self = this;
  
          try {
            if (this.config.environment !== 'production') {
              document.addEventListener('keydown', function (evtDown) {
                if (evtDown.ctrlKey && evtDown.altKey) {
                  document.addEventListener('keyup', function (evtUp) {
                    switch (evtUp.key) {
                      case 'f':
                        _self.autoFillRegForm(false);
  
                        break;
  
                      case 'p':
                        _self.autoFillRegForm(true);
                    ...
                    evtUp.stopImmediatePropagation();
                    return false;
                  });
                  evtDown.preventDefault();
                  evtDown.stopPropagation();
                  evtDown.stopImmediatePropagation();
                  return false;
                }
              });
            }
  
            _self.formElement.addEventListener('submit', function (evt) {
              try {
                var _self$config$form$ema, _self$config$form, _self$config$form$ema2, _self$config$form$ema3, _self$config$form$pas, _self$config$form2, _self$config$form2$pa, _self$config$form2$pa2, _self$config$form$cur, _self$config$form3, _self$config$form3$cu, _self$config$form3$cu2, _self$config$form$nic, _self$config$form4, _self$config$form4$ni, _self$config$form4$ni2, _self$config$form$fir, _self$config$form5, _self$config$form5$fi, _self$config$form5$fi2, _self$config$form$las, _self$config$form6, _self$config$form6$la, _self$config$form6$la2, _self$config$form$cou, _self$config$form7, _self$config$form7$co, _self$config$form7$co2;
                ...
                var formData = {
                  user_type: 'player',
                  email: (_self$config$form$ema = (_self$config$form = _self.config.form) === null || _self$config$form === void 0 ? void 0 : (_self$config$form$ema2 = _self$config$form.email) === null || _self$config$form$ema2 === void 0 ? void 0 : (_self$config$form$ema3 = _self$config$form$ema2._el) === null || _self$config$form$ema3 === void 0 ? void 0 : _self$config$form$ema3.value) !== null && _self$config$form$ema !== void 0 ? _self$config$form$ema : null,
                  password: (_self$config$form$pas = (_self$config$form2 = _self.config.form) === null || _self$config$form2 === void 0 ? void 0 : (_self$config$form2$pa = _self$config$form2.password) === null || _self$config$form2$pa === void 0 ? void 0 : (_self$config$form2$pa2 = _self$config$form2$pa._el) === null || _self$config$form2$pa2 === void 0 ? void 0 : _self$config$form2$pa2.value) !== null && _self$config$form$pas !== void 0 ? _self$config$form$pas : null,
                  currency: (_self$config$form$cur = (_self$config$form3 = _self.config.form) === null || _self$config$form3 === void 0 ? void 0 : (_self$config$form3$cu = _self$config$form3.currency) === null || _self$config$form3$cu === void 0 ? void 0 : (_self$config$form3$cu2 = _self$config$form3$cu._el) === null || _self$config$form3$cu2 === void 0 ? void 0 : _self$config$form3$cu2.value) !== null && _self$config$form$cur !== void 0 ? _self$config$form$cur : null,
                  iovation: _self.config.tracking.iovation,
                  ip: _self.config.ip,
                  play_mode: _self.config.playMode,
                  player_info: {
                    nickname: (_self$config$form$nic = (_self$config$form4 = _self.config.form) === null || _self$config$form4 === void 0 ? void 0 : (_self$config$form4$ni = _self$config$form4.nickname) === null || _self$config$form4$ni === void 0 ? void 0 : (_self$config$form4$ni2 = _self$config$form4$ni._el) === null || _self$config$form4$ni2 === void 0 ? void 0 : _self$config$form4$ni2.value) !== null && _self$config$form$nic !== void 0 ? _self$config$form$nic : null,
                    firstname: (_self$config$form$fir = (_self$config$form5 = _self.config.form) === null || _self$config$form5 === void 0 ? void 0 : (_self$config$form5$fi = _self$config$form5.firstname) === null || _self$config$form5$fi === void 0 ? void 0 : (_self$config$form5$fi2 = _self$config$form5$fi._el) === null || _self$config$form5$fi2 === void 0 ? void 0 : _self$config$form5$fi2.value) !== null && _self$config$form$fir !== void 0 ? _self$config$form$fir : null,
                    lastname: (_self$config$form$las = (_self$config$form6 = _self.config.form) === null || _self$config$form6 === void 0 ? void 0 : (_self$config$form6$la = _self$config$form6.lastname) === null || _self$config$form6$la === void 0 ? void 0 : (_self$config$form6$la2 = _self$config$form6$la._el) === null || _self$config$form6$la2 === void 0 ? void 0 : _self$config$form6$la2.value) !== null && _self$config$form$las !== void 0 ? _self$config$form$las : null,
                    title: null,
                    birth_date: '',
                    home_phone: null,
                    work_phone: null,
                    mobile_phone: _self.config.itiNum.getNumber(),
                    address: {
                      first_line: null,
                      second_line: null,
                      city: null,
                      zip_code: null,
                      country_code: (_self$config$form$cou = (_self$config$form7 = _self.config.form) === null || _self$config$form7 === void 0 ? void 0 : (_self$config$form7$co = _self$config$form7.country) === null || _self$config$form7$co === void 0 ? void 0 : (_self$config$form7$co2 = _self$config$form7$co._el) === null || _self$config$form7$co2 === void 0 ? void 0 : _self$config$form7$co2.value) !== null && _self$config$form$cou !== void 0 ? _self$config$form$cou : _self.config["default"].country,
                      state_code: null,
                      state_text: null
                    }
                  }
                ...
                if (visitorId !== null && typeof _self.config.fpjs.token === 'string' && _self.isValidURL(_self.config.fpjs.endpoint)) {
                  try {
                    _self.config.fpjs.deviceID = visitorId;
                    formData.device_id = visitorId;
                  } catch (error) {
                    _self.error({
                      level: 'Error',
                      originalError: error,
                      consoleMessage: 'Field to parse FPJS Device ID from local storage'
                    });
                  }
                }
  
                if (_self.config.captchaStatus.type === 'reCAPTCHAv2') {
                  formData.captcha = {
                    type: 'reCAPTCHAv2',
                    token: _self.config.recaptchaToken
                  };
                }
  
                if (!_self.formElement.classList.contains('--submitting')) {
                  _self.formElement.classList.add('--submitting');
                }
  
                _self.ajax(_self.config.apiEndpoint + '/users', {
                  method: 'POST',
                  mode: 'cors',
                  cache: 'no-cache',
                  referrerPolicy: 'origin',
                  headers: {
                    'X-Kore-ReturnUrl': _self.config.returnURL,
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + _self.config.brandPublicCredentials.bearer_token.value
                  },
                  body: JSON.stringify(formData)
                }).then(function (response) {
                  response.json().then(function (apiResponse) {
                    if (response.status >= 200 && response.status < 300) {
                      if (window.navigator.userAgent.toLowerCase().match(/blueion/gi) !== null) {
                        _self.pushGoogleTagEvent('apk_registration');
                      } else {
                        _self.pushGoogleTagEvent('web_registration');
                      }
  
                      if (_self.callbacks.onRegistrationSuccess !== null) {
                        /** @TODO: Review in future, for now handler consolidation is essential
                        if (_self.formElement.classList.contains('--submitting')) {
                          _self.formElement.classList.remove('--submitting');
                        }
                        _self.callbacks.onRegistrationSuccess(response.status, apiResponse, _self);
                         /** **/
                        _self.handleRegistrationSuccess(apiResponse);
                      } else {
                        _self.handleRegistrationSuccess(apiResponse);
                      }
                    } else {
                      ...
                      if (_self.callbacks.onRegistrationFailure !== null) {
                        _self.callbacks.onRegistrationFailure(apiResponse.statusCode, apiResponse, _self);
                      } else {
                        _self.handleRegistrationFailure(apiResponse, formData);
                      }
                    }
                  });
                });
            ...
            window.dispatchEvent(evtArisRegFormLoaded);
          } catch (error) {
            _self.error({
              level: 'Critical',
              originalError: error,
              consoleMessage: 'Failed to bind form submission'
            });
          }
        }
      }, {
        key: "updateAffOfferExpiry",
        value: function updateAffOfferExpiry() {
          var _self = this;
  
          try {
            var affOffer = Cookies.getJSON('aff_offer');
  
            if (_typeof(affOffer) === 'object') {
              if (!affOffer.hasOwnProperty('days_valid_after_reg')) {
                affOffer.days_valid_after_reg = 14;
              }
  
              _self.setCookie({
                name: 'aff_offer',
                value: JSON.stringify(affOffer),
                expires: affOffer.days_valid_after_reg
              }).then(function (affOfferCookie) {
                if (_self.config.debug) {
                  console.info('Successfully updated aff_offer cookie expiry >>>', affOfferCookie);
                }
              })["catch"](function (error) {
                throw error;
              });
            ...
            _self.error({
              level: 'Warning',
              originalError: error,
              consoleMessage: 'Could not set post registration expiration for aff_offer'
            });
          }
        }
      }, {
        key: "handleRegistrationSuccess",
        value: function handleRegistrationSuccess(apiResponse) {
          var _self = this;
  
          if (apiResponse.hasOwnProperty('registration_status')) {
            switch (apiResponse.registration_status.toLowerCase()) {
              case 'success':
                if (apiResponse.hasOwnProperty('auth') && apiResponse.auth.hasOwnProperty('tokens')) {
                  var bearer = _self.getBearerToken(apiResponse.auth);
  
                  apiResponse.auth['access_token'] = bearer;
                  apiResponse.auth['kore_version'] = _self.config.koreEndpoint.split('.').shift();
  
                  _self.setCookie({
                    expires: new Date(bearer.expiration),
                    name: _self.config.brand + '.Cred',
                    value: apiResponse.auth
                  }).then(function () {
                    // All is well, redirect to site with autologin
                    _self.updateAffOfferExpiry();
  
                    if (window.navigator.userAgent.toLowerCase().match(/blueion/gi) !== null) {
                      _self.pushGoogleTagEvent('apk_registration_success');
  
                      _self.pushGoogleTagEvent('apk_login_success');
                    } else {
                      _self.pushGoogleTagEvent('web_registration_success');
  
                      _self.pushGoogleTagEvent('web_login_success');
                    }
                    ...
                    _self.error({
                      originalError: error,
                      consoleMessage: 'Failed to set Cred cookie'
                    });
  
                    _self.nukeTheCookies();
              ...
              case 'accountunderreview':
                ...
                if (window.navigator.userAgent.toLowerCase().match(/blueion/gi) !== null) {
                  _self.pushGoogleTagEvent('apk_account_under_review');
                } else {
                  _self.pushGoogleTagEvent('web_account_under_review');
                }
  
                _self.setCookie({
                  name: 'popup',
                  value: {
                    preset: 'accountunderreview'
                  },
                  expires: 1
                }).then(function () {
                  _self.redirect();
                  ...
                  _self.fallback({
                    msg: 'Your account is under review. Please contact support.'
                  });
                });
              ...
              case 'emailverificationrequired':
                ...
                if (window.navigator.userAgent.toLowerCase().match(/blueion/gi) !== null) {
                  _self.pushGoogleTagEvent('apk_email_verification_required');
                } else {
                  _self.pushGoogleTagEvent('web_email_verification_required');
                }
  
                _self.setCookie({
                  name: 'popup',
                  value: {
                    preset: 'emailverificationrequired'
                  },
                  expires: 1
                }).then(function () {
                  _self.redirect();
                  ...
                  _self.fallback({
                    msg: 'Your account email requires verification. Please contact support.'
                  });
                });
              ...
              default:
                ...
                if (window.navigator.userAgent.toLowerCase().match(/blueion/gi) !== null) {
                  _self.pushGoogleTagEvent('apk_registration_fallback');
                } else {
                  _self.pushGoogleTagEvent('web_registration_fallback');
                }
          ...
          } else if (apiResponse.hasOwnProperty('_actions')) {
            if (_typeof(apiResponse._actions) === 'object' && apiResponse._actions.hasOwnProperty('follow')) {
              var _apiResponse$_actions, _apiResponse$_actions2;
              ...
              _self.redirect({
                link: (_apiResponse$_actions = (_apiResponse$_actions2 = apiResponse._actions.follow) === null || _apiResponse$_actions2 === void 0 ? void 0 : _apiResponse$_actions2.href) !== null && _apiResponse$_actions !== void 0 ? _apiResponse$_actions : null,
                skipValidation: true
              });
            } else {
              _self.error({
                originalError: new Error('Unable to action API follow link'),
                apiError: apiResponse,
                fallback: function fallback() {
                  _self.fallback({
                    msg: 'You may have an account with us already. Please contact support'
                  });
                }
              });
            }
            ...
            _self.error({
              originalError: new Error('API Response contains no actions or status'),
              apiError: apiResponse,
              fallback: function fallback() {
                _self.fallback({
                  msg: 'If you have difficulty signing in, please contact support'
                });
              }
            });
          }
        ...
        key: "handleRegistrationFailure",
        value: function handleRegistrationFailure(apiResponse, formData) {
          apiResponse.request = {
            headers: {
              'X-Kore-ReturnUrl': this.config.returnURL,
              'Content-Type': 'application/json',
              'Authorization': 'Bearer ' + this.config.brandPublicCredentials.bearer_token.value
            },
            data: formData
          };
          this.error({
            apiError: apiResponse,
            consoleMessage: 'Registration Submission Failed'
          });
        }
      }, {
        key: "fallback",
        value: function fallback() {
          ...
          try {
            if (typeof data.msg === 'string' && data.msg.trim() !== '') {
              Global.Actions().promptLogin({
                msg: this.translate(data.msg)
              });
            } else {
              throw new Error('Fallback message is not defined');
            }
          } catch (error) {
            var _self = this;
            ...
            this.error({
              originalError: error,
              consoleMessage: 'Defaulting to final fallback',
              fallback: function fallback() {
                var queryParams = ['open=login'];
  
                if (typeof data.msg === 'string' && data.msg.trim() !== '') {
                  queryParams.push('msg=' + _self.translate(data.msg));
                }
        ...
        value: function redirect(data) {
          try {
            ...
            data.skipValidation = data.skipValidation === true;
  
            if (!Array.isArray(data.queryParams)) {
              data.queryParams = [];
            }
  
            if (!data.skipValidation && !this.isValidURL(data.link)) {
              data.link = this.config.returnURL;
            }
  
            if (data.link.indexOf('?') > -1) {
              var split = data.link.split('?');
              data.link = split[0];
  
              if (typeof split[1] === 'string' && split[1].trim() !== '') {
                data.queryParams.push(split[1]);
              }
            }
  
            if (this.config.autoLogin === false) {
              data.queryParams.push('open=login');
            }
  
            if (data.queryParams.length > 0) {
              data.link = data.link + '?' + data.queryParams.join('&');
            }
            ...
            this.error({
              originalError: error,
              consoleMessage: 'Failed to gracefully redirect. Performing force redirect'
            });
            window.location.href = this.config.returnURL + '?open=login';
          }
        }
      }, {
        key: "detectDefaultCurrencyByCountry",
        value: function detectDefaultCurrencyByCountry(country) {
          ...
          var availableCurrencies = Object.keys(this.config.currencies);
  
          if (this.config["default"].currency === null) {
            country = typeof country === 'string' && country.length === 2 ? country : this.config["default"].country;
            country = country = typeof country === 'string' ? country.toUpperCase() : 'US';
  
            if (currenciesByCountry.hasOwnProperty(country)) {
              this.config["default"].currency = currenciesByCountry[country];
            } else if (Array.isArray(availableCurrencies) && availableCurrencies.length > 0 && availableCurrencies.indexOf('USD') > -1) {
              this.config["default"].currency = 'USD';
            } else if (Array.isArray(availableCurrencies)) {
              this.config["default"].currency = Object.keys(this.config.currencies)[0] || 'USD';
            } else {
              this.config["default"].currency = 'USD';
            }
          }
  
          var selectedCurrency = currenciesByCountry[country] || this.config["default"].currency;
          return {
            currency: selectedCurrency,
            available: availableCurrencies.includes(selectedCurrency)
          };
        }
      }, {
        key: "adjustCurrencyAndDialCodeByCountry",
        value: function adjustCurrencyAndDialCodeByCountry(countryCode) {
          this.config.itiNum.setCountry(countryCode);
          var selectedCurrency = this.detectDefaultCurrencyByCountry(countryCode);
  
          if (selectedCurrency.available) {
            document.querySelector('[name="currency"]').querySelectorAll('option').forEach(function (opt) {
              opt.removeAttribute('selected');
  
              if (opt.value === selectedCurrency.currency) {
        ...
        key: "checkNested",
        value: function checkNested(obj, args) {
        ...
        value: function parseTracking() {
          ...
          return new Promise(function (resolve, reject) {
            try {
              ...
              var TrackingToken = qPs['TrackingToken'] || _self.getCookie('kore.tracking.apk') || null;
              var cid = qPs['cid'] || _self.getCookie('kore.tracking.cid') || null;
              var mid = qPs['mid'] || _self.getCookie('kore.tracking.mid') || null;
              var rt = qPs['rt'] || _self.getCookie('kore.tracking.rt') || null;
  
              if (TrackingToken === null && cid === null && rt === null) {
                _self.updateWindowConfig();
  
                resolve(isset);
              } else {
                if (TrackingToken !== null) {
                  TrackingToken = TrackingToken.replace(/^ma-/gi, '');
  
                  _self.setCookie({
                    name: 'kore.tracking.apk',
                    value: TrackingToken,
                    expires: cookieExpiry
                  }).then(function (trackingTokenCookie) {
                    if (_self.config.debug) {
                      console.info('Successfully set TrackingToken cookie >>>', trackingTokenCookie);
                    }
  
                    isset.trackingtoken = true;
                    _self.config.tracking.url = _self.addQueryParam(_self.config.tracking.url, 'TrackingToken', TrackingToken);
                    ...
                    _self.error({
                      originalError: error,
                      consoleMessage: 'Failed to set CID cookie'
                    });
                  });
                }
                ...
                if (cid !== null) {
                  _self.setCookie({
                    name: 'kore.tracking.cid',
                    value: cid,
                    expires: cookieExpiry
                  }).then(function (cidCookie) {
                    if (_self.config.debug) {
                      console.info('Successfully set CID cookie >>>', cidCookie);
                    }
  
                    isset.cid = true;
                    _self.config.tracking.url = _self.addQueryParam(_self.config.tracking.url, 'cid', cid);
                ...
                if (mid !== null) {
                  _self.setCookie({
                    name: 'kore.tracking.mid',
                    value: mid,
                    expires: cookieExpiry
                  }).then(function (midCookie) {
                    if (_self.config.debug) {
                      console.info('Successfully set MID cookie >>>', midCookie);
                    }
  
                    isset.mid = true;
                    _self.config.tracking.url = _self.addQueryParam(_self.config.tracking.url, 'mid', mid);
                    ...
                    _self.error({
                      originalError: error,
                      consoleMessage: 'Failed to set MID cookie'
                    });
                  });
                }
                ...
                if (rt !== null) {
                  _self.setCookie({
                    name: 'kore.tracking.rt',
                    value: rt,
                    expires: cookieExpiry
                  }).then(function (rtCookie) {
                    if (_self.config.debug) {
                      console.info('Successfully set RT cookie >>>', rtCookie);
                    }
  
                    isset.rt = true;
                    _self.config.tracking.url = _self.addQueryParam(_self.config.tracking.url, 'rt', rt);
                    ...
                    _self.error({
                      originalError: error,
                      consoleMessage: 'Failed to set RT cookie'
                    });
                  });
                }
              }
        ...
        key: "updateWindowConfig",
        value: function updateWindowConfig() {
          if (window.hasOwnProperty('arisRegistration')) {
            var formID = this.formElement.getAttribute('id');
  
            if (window.arisRegistration.hasOwnProperty(formID)) {
              window.arisRegistration[formID]['config'] = this.config;
            } else {
              window.arisRegistration.config = this.config;
            }
          }
        }
      }, {
        key: "waitFor",
        value: function waitFor(keyOrSelector, callback, fallback) {
          var triesLeft = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 10;
          var delay = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 300;
  
          var _self = this;
  
          var element = null;
  
          if (keyOrSelector.charAt(0) === '.' || keyOrSelector.charAt(0) === '#') {
            element = document.querySelector(keyOrSelector);
          }
  
          if (element !== null || _self.checkNested(window, keyOrSelector.split('.'))) {
            callback();
          } else {
            if (triesLeft > 0) {
              triesLeft--;
              setTimeout(function () {
                _self.waitFor(keyOrSelector, callback, fallback, triesLeft, delay);
              }, delay);
            } else {
              fallback();
            }
        ...
        key: "showGeoRedirectPopup",
        value: function showGeoRedirectPopup(config) {
          var _self = this;
  
          var geoRedirectWhitelist = ['105.27.203.6', '105.27.203.10', '165.255.250.111', '154.73.5.99', '196.250.247.168', '134.209.205.16', '95.179.184.131', '64.227.77.242'];
  
          if (geoRedirectWhitelist.indexOf(this.config.ip) > -1) {
            return false;
          }
  
          if (_typeof(config) === 'object' && _typeof(config.fromBrand) === 'object' && config.fromBrand !== null && _typeof(config.toBrand) === 'object' && config.toBrand !== null) {
            config.template = this.isValidURL(config.template) ? config.template : 'https://ca-assets.cerebrospace.net/welcome/templates/geo-popups/default.html';
  
            switch (_self.config.environment) {
              case 'staging':
                config.redirectURL = config.toBrand.website_url.replace(/www\./gi, 'welcome.') + '/staging/index.html';
                break;
  
              case 'development':
                config.redirectURL = config.toBrand.website_url.replace(/www\./gi, 'welcome.') + '/dev/index.html';
                break;
  
              case 'production':
              default:
                config.redirectURL = config.toBrand.website_url.replace(/www\./gi, 'welcome.');
                break;
            }
  
            _self.ajax(config.template).then(function (response) {
              response.text().then(function (popupHTML) {
                document.querySelector('html').classList.add('-redirect');
                var matches = popupHTML.match(/{{(.+?)}}/gi) || [];
                var replacementData = config.toBrand['geoPopups'][_self.config.geoCountry] || config.toBrand['geoPopups']['_default'];
                matches.forEach(function (match) {
                  var replacement = match.replace(/({{|}})/gi, '').trim().toLowerCase();
  
                  if (replacement === 'url') {
                    popupHTML = popupHTML.replace(match, config.redirectURL);
                  } else {
                    popupHTML = popupHTML.replace(match, replacementData[replacement]);
                  }
                });
                var redirectPopup = document.createElement('div');
                redirectPopup.setAttribute('class', 'c-redirect');
                redirectPopup.innerHTML = popupHTML;
                redirectPopup.style.zIndex = '10000';
  
                redirectPopup.onload = function () {
                  var ctaButton = document.querySelector('.c-redirect-container__text-wrapper > a');
                ...
                document.body.appendChild(redirectPopup);
  
                _self.pushGoogleTagEvent('geo_impression');
              });
            });
      ...
      return arisRegistration;
    }();
  
    window.initArisRegistration = function (userConfig) {
      var cookieCheck = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      window.arisRegistrationVendors = [];
      window.arisRegistrationCache = {};
  
      if (cookieCheck && (!window.hasOwnProperty('Cookies') || _typeof(window.Cookies) !== 'object')) {
        __webpack_require__.e(/*! import() | js-cookie */ "js-cookie").then(__webpack_require__.t.bind(__webpack_require__, /*! js-cookie/src/js.cookie */ "./node_modules/js-cookie/src/js.cookie.js", 23)).then(function (CookiesModule) {
          window.Cookies = CookiesModule["default"];
        })["catch"](function (error) {
          console.error('Cookies JS is required for RegJS to work >>>', error);
        })["finally"](function () {
          initArisRegistration(userConfig, false);
        });
      } else if (_typeof(userConfig) === 'object') {
        if (typeof userConfig.form !== 'undefined') {
          window.arisRegistration = new arisRegistration(userConfig);
        } else {
          var formElements = document.querySelectorAll('form[data-aris-registration]');
  
          if (_typeof(formElements) === 'object' && formElements !== null && formElements.length === 1) {
            userConfig.form = formElements[0];
            window.arisRegistration = new arisRegistration(userConfig);
          } else if (_typeof(formElements) === 'object' && formElements !== null && formElements.length > 1) {
            var formCount = 0;
            var arisRegistrations = {
              cache: {}
            };
            formElements.forEach(function (formElement) {
              formCount++;
              userConfig.form = formElement;
              var formID = userConfig.form.getAttribute('id');
  
              if (typeof formID === 'undefined' || formID === null) {
                userConfig.form.setAttribute('id', 'aris_registration_form_' + formCount);
              }
  
              arisRegistrations[userConfig.form.getAttribute('id')] = new arisRegistration(userConfig);
            });
            arisRegistrations.formCount = formCount;
            window.arisRegistration = arisRegistrations;
          }
        }
      }
    };
